...
namespace TimeAttendanceSystem.Infrastructure.Migrations
{
    ...
    [Migration("20250925162447_AddVacationTypeColumns")]
    partial class AddVacationTypeColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TimeAttendanceSystem.Domain.VacationTypes.VacationType", b =>
                {
                    ...
                    b.HasIndex("AccrualType")
                        .HasDatabaseName("IX_VacationTypes_AccrualType")
                        .HasFilter("IsDeleted = 0");
                    ...
                    b.ToTable("VacationTypes", null, t =>
                        {
                            t.HasCheckConstraint("CK_VacationTypes_AccrualRate_NonNegative", "[AccrualRate] >= 0");

                            t.HasCheckConstraint("CK_VacationTypes_Color_Format", "[Color] IS NULL OR ([Color] LIKE '#[0-9A-Fa-f][0-9A-Fa-f][0-9A-Fa-f][0-9A-Fa-f][0-9A-Fa-f][0-9A-Fa-f]')");

                            t.HasCheckConstraint("CK_VacationTypes_DefaultDaysPerYear_Positive", "[DefaultDaysPerYear] > 0");

                            t.HasCheckConstraint("CK_VacationTypes_MaxCarryoverDays_Positive", "[MaxCarryoverDays] IS NULL OR [MaxCarryoverDays] > 0");

                            t.HasCheckConstraint("CK_VacationTypes_MaxDaysPerRequest_Positive", "[MaxDaysPerRequest] > 0");

                            t.HasCheckConstraint("CK_VacationTypes_MinDaysNotice_NonNegative", "[MinDaysNotice] >= 0");
                        });
                });

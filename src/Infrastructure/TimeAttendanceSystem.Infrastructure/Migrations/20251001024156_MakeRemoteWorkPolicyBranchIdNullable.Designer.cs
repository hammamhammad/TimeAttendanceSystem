...
namespace TimeAttendanceSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251001024156_MakeRemoteWorkPolicyBranchIdNullable")]
    partial class MakeRemoteWorkPolicyBranchIdNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeAttendanceSystem.Domain.Attendance.AttendanceRecord", b =>
                {
                    ...
                    b.Property<long?>("RemoteWorkAssignmentId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RemoteWorkAssignmentId")
                        .HasDatabaseName("IX_AttendanceRecords_RemoteWorkAssignment");
            ...
            modelBuilder.Entity("TimeAttendanceSystem.Domain.RemoteWork.RemoteWorkAssignment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ApprovedByManagerId")
                        .HasDatabaseName("IX_RemoteWorkAssignments_ApprovedByManagerId");

                    b.HasIndex("AssignedByUserId")
                        .HasDatabaseName("IX_RemoteWorkAssignments_AssignedByUserId");

                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("IX_RemoteWorkAssignments_EmployeeId");

                    b.HasIndex("EndDate")
                        .HasDatabaseName("IX_RemoteWorkAssignments_EndDate");

                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_RemoteWorkAssignments_IsDeleted");

                    b.HasIndex("RemoteWorkPolicyId")
                        .HasDatabaseName("IX_RemoteWorkAssignments_RemoteWorkPolicyId");

                    b.HasIndex("StartDate")
                        .HasDatabaseName("IX_RemoteWorkAssignments_StartDate");

                    b.HasIndex("Status")
                        .HasDatabaseName("IX_RemoteWorkAssignments_Status");

                    b.HasIndex("EmployeeId", "StartDate", "EndDate")
                        .HasDatabaseName("IX_RemoteWorkAssignments_Employee_Dates");

                    b.HasIndex("EmployeeId", "Status", "StartDate")
                        .HasDatabaseName("IX_RemoteWorkAssignments_Employee_Status_StartDate");

                    b.ToTable("RemoteWorkAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("TimeAttendanceSystem.Domain.Attendance.AttendanceRecord", b =>
                {
                    ...
                    b.HasOne("TimeAttendanceSystem.Domain.RemoteWork.RemoteWorkAssignment", "RemoteWorkAssignment")
                        .WithMany()
                        .HasForeignKey("RemoteWorkAssignmentId")
                    ...
                    b.Navigation("RemoteWorkAssignment");
            ...
            modelBuilder.Entity("TimeAttendanceSystem.Domain.RemoteWork.RemoteWorkAssignment", b =>
                {
                    b.HasOne("TimeAttendanceSystem.Domain.Users.User", "ApprovedByManager")
                        .WithMany()
                        .HasForeignKey("ApprovedByManagerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TimeAttendanceSystem.Domain.Users.User", "AssignedByUser")
                        .WithMany()
                    ...
                    b.HasOne("TimeAttendanceSystem.Domain.RemoteWork.RemoteWorkPolicy", "RemoteWorkPolicy")
                        .WithMany("RemoteWorkAssignments")
            ...
            modelBuilder.Entity("TimeAttendanceSystem.Domain.RemoteWork.RemoteWorkPolicy", b =>
                {
                    b.Navigation("RemoteWorkAssignments");
                });

...
/// Validates only the simplified vacation type properties: Id, Name, NameAr, and BranchId.
/// </summary>
/// <remarks>
/// Validation Categories:
/// - Entity Existence Validation: Ensures the vacation type ID exists and is accessible
...
/// </remarks>
public class UpdateVacationTypeCommandValidator : AbstractValidator<UpdateVacationTypeCommand>
{
    /// <summary>
    /// Initializes the validator with simplified validation rules for vacation type updates.
    /// Configures validation constraints for Id, Name, NameAr, and BranchId only.
    /// </summary>
    public UpdateVacationTypeCommandValidator()
    {
        ...
        RuleFor(x => x.Id)
            .GreaterThan(0)
            .WithMessage("Vacation type ID is required and must be a positive number");

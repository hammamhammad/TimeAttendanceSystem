...
/// </summary>
public interface ICompanyPayrollCalendarService
{
    /// <summary>
    ...
    /// (branch-specific first, company-wide fallback). Falls back to <c>DateTime.DaysInMonth</c> if
...
public sealed class CompanyPayrollCalendarService : ICompanyPayrollCalendarService
{
    private readonly IApplicationDbContext _context;
    private readonly ILogger<CompanyPayrollCalendarService> _logger;

    public CompanyPayrollCalendarService(IApplicationDbContext context, ILogger<CompanyPayrollCalendarService> logger)
    {
        _context = context;
        _logger = logger;
    }

...
public class CreateShiftCommandValidator : AbstractValidator<CreateShiftCommand>
{
    public CreateShiftCommandValidator()
    {
        ...
        RuleForEach(x => x.ShiftPeriods)
            .SetValidator(new CreateShiftPeriodCommandValidator())
            .When(x => x.ShiftPeriods != null);
...
/// <summary>
/// Validator for individual shift periods.
/// </summary>
public class CreateShiftPeriodCommandValidator : AbstractValidator<CreateShiftPeriodCommand>
{
    public CreateShiftPeriodCommandValidator()
    {
        ...
        // Note: We allow EndTime < StartTime for night shifts, but we validate in business logic
    }
}
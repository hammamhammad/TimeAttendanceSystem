-- Insert Arabic Test Data - Fixed to use existing branch
...
-- Insert departments with proper Arabic encoding - using only branch ID 1 (Head Quarters)
...
(1, 'DEPT04', 'Marketing', N'التسويق', 'Brand management, advertising, and customer outreach', N'إدارة العلامة التجارية والإعلان والتواصل مع العملاء', 1, 4, GETUTCDATE(), 'TestDataScript', 0),
(1, 'DEPT05', 'Operations', N'العمليات', 'Daily operations, logistics, and process management', N'العمليات اليومية واللوجستيات وإدارة العمليات', 1, 5, GETUTCDATE(), 'TestDataScript', 0);
...
-- Finance Employees (Department 3)
...
-- Marketing Employees (Department 4)
(1, 4, 'EMP007', 'Zainab', 'Al-Farisi', N'زينب', N'الفارسي', 'zainab.alfarisi@company.com', '+966501234575', '2023-05-01', 1, 'Marketing Manager', N'مدير تسويق', 1, GETUTCDATE(), 'TestDataScript', 0),
(1, 4, 'EMP008', 'Hassan', 'Al-Omari', N'حسان', N'العمري', 'hassan.alomari@company.com', '+966501234576', '2023-05-15', 1, 'Marketing Specialist', N'أخصائي تسويق', 1, GETUTCDATE(), 'TestDataScript', 0),

-- Operations Employees (Department 5)
(1, 5, 'EMP009', 'Mariam', 'Al-Dosari', N'مريم', N'الدوسري', 'mariam.aldosari@company.com', '+966501234577', '2023-06-01', 1, 'Operations Manager', N'مدير العمليات', 1, GETUTCDATE(), 'TestDataScript', 0),
(1, 5, 'EMP010', 'Saeed', 'Al-Ghamdi', N'سعيد', N'الغامدي', 'saeed.alghamdi@company.com', '+966501234578', '2023-06-15', 1, 'Operations Coordinator', N'منسق عمليات', 1, GETUTCDATE(), 'TestDataScript', 0);

PRINT 'Employees with proper Arabic encoding inserted';

-- Verify the data was inserted correctly
SELECT 'Departments with Arabic names:' as Info;
SELECT Id, BranchId, Code, Name, NameAr FROM Departments WHERE NameAr IS NOT NULL ORDER BY SortOrder;
...
FROM Employees WHERE FirstNameAr IS NOT NULL ORDER BY Id;

...
export class FingerprintRequestsListComponent implements OnInit, OnDestroy {
  ...
  createRequest(): void {
    this.router.navigate(['/fingerprint-requests/new']);
  }
  ...
  viewRequest(request: FingerprintRequest): void {
    this.router.navigate(['/fingerprint-requests', request.id]);
  }

  editRequest(request: FingerprintRequest): void {
    this.router.navigate(['/fingerprint-requests', request.id, 'edit']);
  }

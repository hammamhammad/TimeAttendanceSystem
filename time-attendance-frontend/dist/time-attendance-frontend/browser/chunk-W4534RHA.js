...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CreateShiftComponent, [{
    type: Component,
    args: [{ selector: "app-create-shift", standalone: true, imports: [CommonModule, FormsModule, FormHeaderComponent, FormSectionComponent], template: `<div class="container-fluid px-4">
  <div class="row">
    <div class="col-12">
      <!-- Header -->
      <app-form-header
...
//# sourceMappingURL=chunk-W4534RHA.js.map

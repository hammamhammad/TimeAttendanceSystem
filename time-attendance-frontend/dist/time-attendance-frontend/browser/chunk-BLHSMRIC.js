...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DepartmentTableComponent, [{
    type: Component,
    args: [{ selector: "app-department-table", standalone: true, imports: [CommonModule, FormsModule, HasPermissionDirective, StatusBadgeComponent, LoadingSpinnerComponent], template: `<div class="department-table">
  <!-- Controls -->
  @if (showControls) {
    <div class="table-controls mb-3">
      ...
      <!-- Bulk Actions -->
      @if (selectedDepartments().size > 0 && allowSelection) {
        <div class="row mt-2">
          <div class="col-12">
    ...
    <div class="table-container">
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tbody>
            @for (dept of getPaginatedDepartments(); track trackByDeptId($index, dept)) {
              <tr [class.table-warning]="!dept.isActive"
                ...
                <td>
                  <div class="d-flex align-items-center">
                    @if (showHierarchy()) {
                      <div [class]="getIndentClass(dept.level)"></div>
                    }
                    <i class="fas fa-building text-primary me-2"></i>
                    <div>
                      <div class="fw-medium">{{ dept.name }}</div>
                      @if (dept.nameAr) {
                        <div class="text-muted small">{{ dept.nameAr }}</div>
                      }
                      @if (dept.description) {
                ...
                <td class="text-center">
                  <app-status-badge
                    ...
                    [label]="dept.employeeCount.toString()">
                  </app-status-badge>
                </td>
                ...
                @if (showControls) {
                  <td class="actions-column">
                    <div class="btn-group btn-group-sm">
                      <button
                        *appHasPermission="PERMISSIONS.DEPARTMENT_READ"
                        type="button"
                        class="btn btn-outline-primary"
                        (click)="onViewDepartment(dept); $event.stopPropagation()"
      ...
      <!-- Empty State -->
      @if (getPaginatedDepartments().length === 0) {
      ...
      <!-- Pagination -->
      @if (totalPages() > 1) {
        <nav aria-label="Department pagination" class="mt-3">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DepartmentTreeComponent, [{
    type: Component,
    args: [{ selector: "app-department-tree", standalone: true, imports: [CommonModule, FormsModule, LoadingSpinnerComponent], template: `<div class="department-tree">
  <!-- Controls -->
  @if (showControls) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DepartmentInfoPanelComponent, [{
    ...
    args: [{ selector: "app-department-info-panel", standalone: true, imports: [
      ...
      HasPermissionDirective,
      StatusBadgeComponent
    ], template: `<!-- Selected Department Info Panel -->
    ...
    <div class="card border-primary">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="row g-2">
              @if (selectedDepartment.managerName) {
                <div class="col-6">
              ...
              <div class="col-6">
                ...
                <app-status-badge
                  ...
                  [label]="selectedDepartment.isActive ? i18n.t('common.active') : i18n.t('common.inactive')"
                  [showIcon]="true">
                </app-status-badge>
              </div>
            </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DepartmentInfoPanelComponent, { className: "DepartmentInfoPanelComponent", filePath: "src/app/pages/departments/department-info-panel/department-info-panel.component.ts", lineNumber: 21 });
})();
...
function DepartmentsComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-department-table", 18);
    \u0275\u0275listener("departmentSelected", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_16_Template_app_department_table_departmentSelected_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentSelected($event));
    }, "DepartmentsComponent_Conditional_16_Template_app_department_table_departmentSelected_0_listener"))("departmentView", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_16_Template_app_department_table_departmentView_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentView($event));
    }, "DepartmentsComponent_Conditional_16_Template_app_department_table_departmentView_0_listener"))("departmentEdit", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_16_Template_app_department_table_departmentEdit_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentEdit($event));
    }, "DepartmentsComponent_Conditional_16_Template_app_department_table_departmentEdit_0_listener"))("departmentDelete", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_16_Template_app_department_table_departmentDelete_0_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentDelete($event));
    }, "DepartmentsComponent_Conditional_16_Template_app_department_table_departmentDelete_0_listener"))("departmentAdd", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_16_Template_app_department_table_departmentAdd_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentAdd());
    }, "DepartmentsComponent_Conditional_16_Template_app_department_table_departmentAdd_0_listener"));
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
__name(DepartmentsComponent_Conditional_16_Template, "DepartmentsComponent_Conditional_16_Template");
function DepartmentsComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-department-tree", 18);
    \u0275\u0275listener("departmentSelected", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentSelected_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentSelected($event));
    }, "DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentSelected_0_listener"))("departmentView", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentView_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentView($event));
    }, "DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentView_0_listener"))("departmentEdit", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentEdit_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentEdit($event));
    }, "DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentEdit_0_listener"))("departmentDelete", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentDelete_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentDelete($event));
    }, "DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentDelete_0_listener"))("departmentAdd", /* @__PURE__ */ __name(function DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentAdd_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onDepartmentAdd($event));
    }, "DepartmentsComponent_Conditional_17_Template_app_department_tree_departmentAdd_0_listener"));
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
__name(DepartmentsComponent_Conditional_17_Template, "DepartmentsComponent_Conditional_17_Template");
...
__publicField(_DepartmentsComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DepartmentsComponent, selectors: [["app-departments"]], decls: 19, vars: 10, consts: [[1, "app-list-page"], [3, "title"], ["moduleName", "departments", 3, "searchChange", "filtersChange", "add", "refresh", "refreshing"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-3"], ["role", "group", 1, "btn-group"], ["type", "radio", "name", "viewMode", "id", "tableMode", 1, "btn-check", 3, "change", "checked"], ["for", "tableMode", 1, "btn", "btn-outline-primary"], [1, "fas", "fa-table", "me-2"], ["type", "radio", "name", "viewMode", "id", "treeMode", 1, "btn-check", 3, "change", "checked"], ["for", "treeMode", 1, "btn", "btn-outline-primary"], [1, "fas", "fa-sitemap", "me-2"], [1, "card"], [1, "card-body"], [1, "alert", "alert-info"], [3, "selectedBranchId", "allowSelection", "allowEdit", "allowDelete", "showControls"], [3, "departmentView", "departmentEdit", "departmentDelete", "closePanel", "selectedDepartment"], [1, "d-flex", "align-items-center"], [1, "fas", "fa-info-circle", "me-3"], [3, "departmentSelected", "departmentView", "departmentEdit", "departmentDelete", "departmentAdd", "selectedBranchId", "allowSelection", "allowEdit", "allowDelete", "showControls"]], template: /* @__PURE__ */ __name(function DepartmentsComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    ...
    \u0275\u0275conditionalCreate(15, DepartmentsComponent_Conditional_15_Template, 9, 2, "div", 13);
    \u0275\u0275conditionalCreate(16, DepartmentsComponent_Conditional_16_Template, 1, 5, "app-department-table", 14);
    \u0275\u0275conditionalCreate(17, DepartmentsComponent_Conditional_17_Template, 1, 5, "app-department-tree", 14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "app-department-info-panel", 15);
    \u0275\u0275listener("departmentView", /* @__PURE__ */ __name(function DepartmentsComponent_Template_app_department_info_panel_departmentView_18_listener($event) {
      return ctx.onDepartmentView($event);
    }, "DepartmentsComponent_Template_app_department_info_panel_departmentView_18_listener"))("departmentEdit", /* @__PURE__ */ __name(function DepartmentsComponent_Template_app_department_info_panel_departmentEdit_18_listener($event) {
      return ctx.onDepartmentEdit($event);
    }, "DepartmentsComponent_Template_app_department_info_panel_departmentEdit_18_listener"))("departmentDelete", /* @__PURE__ */ __name(function DepartmentsComponent_Template_app_department_info_panel_departmentDelete_18_listener($event) {
      return ctx.onDepartmentDelete($event);
    }, "DepartmentsComponent_Template_app_department_info_panel_departmentDelete_18_listener"))("closePanel", /* @__PURE__ */ __name(function DepartmentsComponent_Template_app_department_info_panel_closePanel_18_listener() {
      return ctx.onCloseInfoPanel();
    }, "DepartmentsComponent_Template_app_department_info_panel_closePanel_18_listener"));
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275conditional(!ctx.selectedBranch() && !ctx.branchesLoading() ? 15 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.viewMode() === "table" ? 16 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.viewMode() === "tree" ? 17 : -1);
    \u0275\u0275advance();
...
`, styles: ["/* src/app/pages/departments/departments.component.css */\n.selected-info {\n  position: fixed;\n  top: 50%;\n  right: 2rem;\n  transform: translateY(-50%);\n  width: 350px;\n  z-index: 1000;\n}\n@media (max-width: 1200px) {\n  .selected-info {\n    position: relative;\n    top: auto;\n    right: auto;\n    transform: none;\n    width: 100%;\n    margin-top: 2rem;\n  }\n}\n/*# sourceMappingURL=departments.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DepartmentsComponent, { className: "DepartmentsComponent", filePath: "src/app/pages/departments/departments.component.ts", lineNumber: 36 });
})();
export {
  DepartmentsComponent
};
//# sourceMappingURL=chunk-BLHSMRIC.js.map

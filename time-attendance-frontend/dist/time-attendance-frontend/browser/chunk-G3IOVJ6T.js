...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DailyAttendanceComponent, [{
    type: Component,
    args: [{ selector: "app-daily-attendance", standalone: true, imports: [FormsModule, RouterModule, SearchableSelectComponent, DataTableComponent, PageHeaderComponent, LoadingSpinnerComponent], template: `<div class="container-fluid p-4">
  <!-- Page Header -->
  <app-page-header
...
//# sourceMappingURL=chunk-G3IOVJ6T.js.map

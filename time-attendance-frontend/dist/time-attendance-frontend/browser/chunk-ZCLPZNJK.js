...
var _AttendanceChartComponent = class _AttendanceChartComponent {
  ...
  loadChartJS() {
    return __async(this, null, function* () {
      try {
        const { Chart, registerables } = yield import("./chunk-Z747M6OZ.js");
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AttendanceChartComponent, [{
    type: Component,
    args: [{ selector: "app-attendance-chart", standalone: true, imports: [EmptyStateComponent], template: `<div class="chart-container">\r
  <!-- Chart Title -->\r
  @if (title) {\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AttendanceSummaryCardComponent, [{
    type: Component,
    args: [{ selector: "app-attendance-summary-card", standalone: true, imports: [RouterModule], template: `<div class="card summary-card" [class]="cardClasses" (click)="onCardClick()">\r
...
//# sourceMappingURL=chunk-ZCLPZNJK.js.map

...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CreateExcusePolicyComponent, [{
    type: Component,
    args: [{ selector: "app-create-excuse-policy", standalone: true, imports: [FormsModule, RouterModule, FormHeaderComponent, FormSectionComponent], template: `<div class="container-fluid">\r
  <app-form-header\r
    mode="create"\r
...
//# sourceMappingURL=chunk-EERGQUYV.js.map

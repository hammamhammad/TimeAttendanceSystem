...
function OvertimeConfigurationsComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 11)(2, "div", 12);
    \u0275\u0275element(3, "i", 13);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function OvertimeConfigurationsComponent_Conditional_7_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onCreateConfiguration());
    }, "OvertimeConfigurationsComponent_Conditional_7_Template_button_click_8_listener"));
    \u0275\u0275element(9, "i", 17);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.t("settings.overtime.noConfigurationsTitle"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.t("settings.overtime.noConfigurationsMessage"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.t("settings.overtime.createFirstPolicy"), " ");
  }
}
__name(OvertimeConfigurationsComponent_Conditional_7_Template, "OvertimeConfigurationsComponent_Conditional_7_Template");
...
__publicField(_OvertimeConfigurationsComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OvertimeConfigurationsComponent, selectors: [["app-overtime-configurations"]], decls: 8, vars: 10, consts: [[1, "container-fluid"], [3, "title"], ["moduleName", "overtime-configurations", 3, "searchChange", "filtersChange", "add", "refresh", "refreshing"], [1, "card"], [1, "card-body"], [3, "actionClick", "data", "columns", "actions", "loading", "paginated", "emptyMessage"], [1, "alert", "alert-info", "d-flex", "align-items-center", "mb-4"], [1, "fa-solid", "fa-info-circle", "me-3", "fs-4"], [1, "flex-grow-1"], [1, "mb-1"], [1, "mb-0"], [1, "card-body", "text-center", "py-5"], [1, "mb-4"], [1, "fa-solid", "fa-clock", "display-1", "text-muted"], [1, "text-muted", "mb-3"], [1, "text-muted", "mb-4"], [1, "btn", "btn-primary", 3, "click"], [1, "fa-solid", "fa-plus", "me-2"]], template: /* @__PURE__ */ __name(function OvertimeConfigurationsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(7, OvertimeConfigurationsComponent_Conditional_7_Template, 11, 3, "div", 3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(OvertimeConfigurationsComponent, [{
    type: Component,
    args: [{ selector: "app-overtime-configurations", standalone: true, imports: [CommonModule, FormsModule, DataTableComponent, PageHeaderComponent, UnifiedFilterComponent], template: `<div class="container-fluid">\r
  <!-- Page Header -->\r
  <app-page-header\r
  ...
  <div class="card">\r
    <div class="card-body">\r
      <app-data-table\r
        ...
        [loading]="loading"\r
        [paginated]="true"\r
        [emptyMessage]="t('settings.overtime.noConfigurations')"\r
  ...
  @if (!loading() && configurations().length === 0) {\r
    <div class="card">\r
      <div class="card-body text-center py-5">\r
        <div class="mb-4">\r
          <i class="fa-solid fa-clock display-1 text-muted"></i>\r
        </div>\r
        <h4 class="text-muted mb-3">{{ t('settings.overtime.noConfigurationsTitle') }}</h4>\r
        <p class="text-muted mb-4">{{ t('settings.overtime.noConfigurationsMessage') }}</p>\r
        <button\r
          class="btn btn-primary"\r
          (click)="onCreateConfiguration()">\r
          <i class="fa-solid fa-plus me-2"></i>\r
          {{ t('settings.overtime.createFirstPolicy') }}\r
        </button>\r
      </div>\r
    </div>\r
  }\r
...
//# sourceMappingURL=chunk-TW2QVESY.js.map

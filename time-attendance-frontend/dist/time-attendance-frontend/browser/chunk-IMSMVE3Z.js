...
function WorkflowFormComponent_Conditional_8_Conditional_56_For_2_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 46)(1, "button", 58);
...
function WorkflowFormComponent_Conditional_8_Conditional_56_For_2_For_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 24);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", action_r10.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(action_r10.label);
  }
}
__name(WorkflowFormComponent_Conditional_8_Conditional_56_For_2_For_45_Template, "WorkflowFormComponent_Conditional_8_Conditional_56_For_2_For_45_Template");
function WorkflowFormComponent_Conditional_8_Conditional_56_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(38, "small", 26);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div", 17)(41, "label", 18);
    \u0275\u0275text(42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "select", 50);
    \u0275\u0275repeaterCreate(44, WorkflowFormComponent_Conditional_8_Conditional_56_For_2_For_45_Template, 2, 2, "option", 24, _forTrack0);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(50);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "textarea", 51);
    \u0275\u0275text(52, "                        ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(53, "div", 30)(54, "div", 16)(55, "div", 52)(56, "div", 53);
    \u0275\u0275element(57, "input", 54);
    \u0275\u0275elementStart(58, "label", 55);
    \u0275\u0275text(59);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(60, "div", 52)(61, "div", 53);
    \u0275\u0275element(62, "input", 56);
    \u0275\u0275elementStart(63, "label", 55);
    \u0275\u0275text(64);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(65, "div", 52)(66, "div", 53);
    \u0275\u0275element(67, "input", 57);
    \u0275\u0275elementStart(68, "label", 55);
    \u0275\u0275text(69);
    \u0275\u0275elementEnd()()()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.t("workflows.timeout_hours_hint"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.t("workflows.timeout_action"));
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r0.timeoutActions);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.t("workflows.timeout_action_hint"));
    \u0275\u0275advance(3);
...
function WorkflowFormComponent_Conditional_8_Conditional_56_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, WorkflowFormComponent_Conditional_8_Conditional_56_For_2_Template, 70, 29, "div", 43, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function WorkflowFormComponent_Conditional_8_Conditional_57_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 39)(1, "button", 63);
    ...
    \u0275\u0275conditionalCreate(4, WorkflowFormComponent_Conditional_8_Conditional_57_Conditional_4_Template, 1, 0, "span", 65);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function WorkflowFormComponent_Conditional_8_Conditional_58_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 40)(1, "button", 66);
...
\r
                      <div class="col-md-6 mb-3">\r
                        ...
                        <small class="text-muted">{{ t('workflows.timeout_hours_hint') }}</small>\r
                      </div>\r
\r
                      <div class="col-md-6 mb-3">\r
                        <label class="form-label">{{ t('workflows.timeout_action') }}</label>\r
                        <select class="form-select" formControlName="timeoutAction">\r
                          @for (action of timeoutActions; track action.value) {\r
                            <option [value]="action.value">{{ action.label }}</option>\r
                          }\r
                        </select>\r
                        <small class="text-muted">{{ t('workflows.timeout_action_hint') }}</small>\r
                      </div>\r
\r
                      <div class="col-md-6 mb-3">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WorkflowFormComponent, { className: "WorkflowFormComponent", filePath: "src/app/pages/settings/workflows/workflow-form/workflow-form.component.ts", lineNumber: 36 });
})();
export {
  WorkflowFormComponent
};
//# sourceMappingURL=chunk-IMSMVE3Z.js.map

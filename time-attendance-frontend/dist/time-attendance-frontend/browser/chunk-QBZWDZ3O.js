...
function EmployeeExcusesComponent_ng_template_10_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 12);
  }
  if (rf & 2) {
...
__name(EmployeeExcusesComponent_ng_template_10_Conditional_2_Template, "EmployeeExcusesComponent_ng_template_10_Conditional_2_Template");
function EmployeeExcusesComponent_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, EmployeeExcusesComponent_ng_template_10_Conditional_2_Template, 1, 1, "i", 12);
  }
  if (rf & 2) {
...
function EmployeeExcusesComponent_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "date");
  }
...
__name(EmployeeExcusesComponent_ng_template_12_Template, "EmployeeExcusesComponent_ng_template_12_Template");
function EmployeeExcusesComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
__name(EmployeeExcusesComponent_Conditional_14_Template, "EmployeeExcusesComponent_Conditional_14_Template");
...
__publicField(_EmployeeExcusesComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmployeeExcusesComponent, selectors: [["app-employee-excuses"]], decls: 15, vars: 14, consts: [["durationTemplate", ""], ["reasonTemplate", ""], ["statusTemplate", ""], ["dateTemplate", ""], [1, "employee-excuses-page"], [3, "title"], ["moduleName", "employee-excuses", 3, "searchChange", "filtersChange", "add", "refresh", "refreshing"], [1, "card"], [1, "card-body"], [3, "pageChange", "pageSizeChange", "actionClick", "data", "columns", "actions", "loading", "totalItems", "currentPage", "pageSize", "pageSizeOptions", "emptyMessage"], ["role", "alert", 1, "alert", "alert-danger", "mt-3"], [1, "text-truncate", "d-inline-block", 2, "max-width", "200px", 3, "title"], ["data-bs-toggle", "tooltip", 1, "fas", "fa-exclamation-triangle", "text-warning", "ms-1", 3, "title"], [1, "fas", "fa-exclamation-triangle", "me-2"]], template: /* @__PURE__ */ __name(function EmployeeExcusesComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 7)(4, "div", 8)(5, "app-data-table", 9);
    \u0275\u0275listener("pageChange", /* @__PURE__ */ __name(function EmployeeExcusesComponent_Template_app_data_table_pageChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onPageChange($event));
    }, "EmployeeExcusesComponent_Template_app_data_table_pageChange_5_listener"))("pageSizeChange", /* @__PURE__ */ __name(function EmployeeExcusesComponent_Template_app_data_table_pageSizeChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onPageSizeChange($event));
    }, "EmployeeExcusesComponent_Template_app_data_table_pageSizeChange_5_listener"))("actionClick", /* @__PURE__ */ __name(function EmployeeExcusesComponent_Template_app_data_table_actionClick_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onTableAction($event));
    }, "EmployeeExcusesComponent_Template_app_data_table_actionClick_5_listener"));
    \u0275\u0275template(6, EmployeeExcusesComponent_ng_template_6_Template, 1, 1, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(8, EmployeeExcusesComponent_ng_template_8_Template, 2, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(10, EmployeeExcusesComponent_ng_template_10_Template, 3, 4, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(12, EmployeeExcusesComponent_ng_template_12_Template, 2, 4, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(14, EmployeeExcusesComponent_Conditional_14_Template, 3, 1, "div", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_10_0;
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("data", ctx.employeeExcuses() || \u0275\u0275pureFunction0(12, _c0))("columns", ctx.tableColumns)("actions", ctx.tableActions)("loading", ctx.loading())("totalItems", ((tmp_10_0 = ctx.pagedResult()) == null ? null : tmp_10_0.totalCount) || 0)("currentPage", ctx.currentPage())("pageSize", ctx.pageSize())("pageSizeOptions", \u0275\u0275pureFunction0(13, _c1))("emptyMessage", ctx.i18n.t("employee_excuses.no_requests_found"));
    \u0275\u0275advance(9);
...
(() => {
  ...
  <!-- Page Header -->\r
  <app-page-header\r
    [title]="i18n.t('employee_excuses.management_title')">\r
  </app-page-header>\r
\r
  <!-- Filters Component -->\r
  ...
  <div class="card">\r
    <div class="card-body">\r
      <app-data-table\r
        ...
        [emptyMessage]="i18n.t('employee_excuses.no_requests_found')"\r
      >\r
...
\r
        <ng-template #reasonTemplate let-item>\r
          <span\r
            [title]="item.reason"\r
            class="text-truncate d-inline-block"\r
...
\r
        <ng-template #statusTemplate let-item>\r
          ...
          @if (!item.isWithinPolicy && item.policyViolationReason) {\r
            <i\r
              class="fas fa-exclamation-triangle text-warning ms-1"\r
              [title]="item.policyViolationReason"\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmployeeExcusesComponent, { className: "EmployeeExcusesComponent", filePath: "src/app/pages/employee-excuses/employee-excuses.component.ts", lineNumber: 32 });
})();
export {
  EmployeeExcusesComponent
};
//# sourceMappingURL=chunk-QBZWDZ3O.js.map

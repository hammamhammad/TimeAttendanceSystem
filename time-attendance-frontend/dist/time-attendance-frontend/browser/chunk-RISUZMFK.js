...
function DefinitionListComponent_ng_template_3_span_2_Template(rf, ctx) {
  if (rf & 1) {
...
__name(DefinitionListComponent_ng_template_3_span_2_Template, "DefinitionListComponent_ng_template_3_span_2_Template");
function DefinitionListComponent_ng_template_3_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(DefinitionListComponent_ng_template_3_span_3_Template, "DefinitionListComponent_ng_template_3_span_3_Template");
function DefinitionListComponent_ng_template_3_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(DefinitionListComponent_ng_template_3_span_4_Template, "DefinitionListComponent_ng_template_3_span_4_Template");
function DefinitionListComponent_ng_template_3_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(DefinitionListComponent_ng_template_3_span_5_Template, "DefinitionListComponent_ng_template_3_span_5_Template");
function DefinitionListComponent_ng_template_3_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(DefinitionListComponent_ng_template_3_span_6_Template, "DefinitionListComponent_ng_template_3_span_6_Template");
function DefinitionListComponent_ng_template_3_span_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(DefinitionListComponent_ng_template_3_span_7_Template, "DefinitionListComponent_ng_template_3_span_7_Template");
function DefinitionListComponent_ng_template_3_a_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 13);
  }
}
__name(DefinitionListComponent_ng_template_3_a_8_Conditional_2_Template, "DefinitionListComponent_ng_template_3_a_8_Conditional_2_Template");
function DefinitionListComponent_ng_template_3_a_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 12);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, DefinitionListComponent_ng_template_3_a_8_Conditional_2_Template, 1, 0, "i", 13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r7 = \u0275\u0275nextContext().item;
...
__name(DefinitionListComponent_ng_template_3_a_8_Template, "DefinitionListComponent_ng_template_3_a_8_Template");
function DefinitionListComponent_ng_template_3_ng_container_9_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
__name(DefinitionListComponent_ng_template_3_ng_container_9_Conditional_1_Template, "DefinitionListComponent_ng_template_3_ng_container_9_Conditional_1_Template");
function DefinitionListComponent_ng_template_3_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275conditionalCreate(1, DefinitionListComponent_ng_template_3_ng_container_9_Conditional_1_Template, 1, 5, "ng-container", 5);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const item_r7 = \u0275\u0275nextContext().item;
    \u0275\u0275advance();
    \u0275\u0275conditional(item_r7.customTemplate ? 1 : -1);
  }
}
__name(DefinitionListComponent_ng_template_3_ng_container_9_Template, "DefinitionListComponent_ng_template_3_ng_container_9_Template");
function DefinitionListComponent_ng_template_3_span_10_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "i", 15);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function DefinitionListComponent_ng_template_3_span_10_Conditional_2_Template_i_click_0_listener($event) {
      \u0275\u0275restoreView(_r8);
      const item_r7 = \u0275\u0275nextContext(2).item;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.copyToClipboard(item_r7.value, $event));
    }, "DefinitionListComponent_ng_template_3_span_10_Conditional_2_Template_i_click_0_listener"));
    \u0275\u0275elementEnd();
  }
}
__name(DefinitionListComponent_ng_template_3_span_10_Conditional_2_Template, "DefinitionListComponent_ng_template_3_span_10_Conditional_2_Template");
function DefinitionListComponent_ng_template_3_span_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, DefinitionListComponent_ng_template_3_span_10_Conditional_2_Template, 1, 0, "i", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const item_r7 = \u0275\u0275nextContext().item;
...
__name(DefinitionListComponent_ng_template_3_span_10_Template, "DefinitionListComponent_ng_template_3_span_10_Template");
function DefinitionListComponent_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(2, DefinitionListComponent_ng_template_3_span_2_Template, 2, 3, "span", 8)(3, DefinitionListComponent_ng_template_3_span_3_Template, 2, 1, "span", 9)(4, DefinitionListComponent_ng_template_3_span_4_Template, 2, 1, "span", 9)(5, DefinitionListComponent_ng_template_3_span_5_Template, 2, 1, "span", 9)(6, DefinitionListComponent_ng_template_3_span_6_Template, 2, 1, "span", 9)(7, DefinitionListComponent_ng_template_3_span_7_Template, 2, 1, "span", 9)(8, DefinitionListComponent_ng_template_3_a_8_Template, 3, 4, "a", 10)(9, DefinitionListComponent_ng_template_3_ng_container_9_Template, 2, 1, "ng-container", 9)(10, DefinitionListComponent_ng_template_3_span_10_Template, 3, 6, "span", 11);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitch", item_r7.type || "text");
    \u0275\u0275advance();
...
__publicField(_DefinitionListComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DefinitionListComponent, selectors: [["app-definition-list"]], inputs: { items: "items", layout: "layout", striped: "striped", bordered: "bordered", compact: "compact", labelWidth: "labelWidth", valueWidth: "valueWidth" }, decls: 5, vars: 3, consts: [["valueTemplate", ""], [1, "row"], [1, "row", "mb-0"], [1, "col-md-6"], [3, "class"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [3, "click"], [3, "ngSwitch"], [3, "class", 4, "ngSwitchCase"], [4, "ngSwitchCase"], ["class", "definition-link", 3, "href", "target", 4, "ngSwitchCase"], [3, "text-muted", "definition-clickable", 4, "ngSwitchDefault"], [1, "definition-link", 3, "href", "target"], [1, "fa-solid", "fa-external-link-alt", "ms-1", "small"], ["title", "Copy to clipboard", 1, "fa-solid", "fa-copy", "ms-2", "text-muted", "definition-copy-icon"], ["title", "Copy to clipboard", 1, "fa-solid", "fa-copy", "ms-2", "text-muted", "definition-copy-icon", 3, "click"]], template: /* @__PURE__ */ __name(function DefinitionListComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, DefinitionListComponent_ng_template_3_Template, 11, 11, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
...
<ng-template #valueTemplate let-item="item">\r
  <div [class]="item.valueClass" (click)="onItemClick(item, $event)">\r
    <ng-container [ngSwitch]="item.type || 'text'">\r
      <!-- Badge type -->\r
      <span *ngSwitchCase="'badge'"\r
            [class]="'badge bg-' + (item.badgeVariant || 'primary')">\r
        {{ item.value }}\r
      </span>\r
\r
      <!-- Date type -->\r
      <span *ngSwitchCase="'date'">\r
        {{ formatDate(item.value) }}\r
      </span>\r
\r
      <!-- Time type -->\r
      <span *ngSwitchCase="'time'">\r
        {{ formatTime(item.value) }}\r
      </span>\r
\r
      <!-- DateTime type -->\r
      <span *ngSwitchCase="'datetime'">\r
        {{ formatDateTime(item.value) }}\r
      </span>\r
\r
      <!-- Currency type -->\r
      <span *ngSwitchCase="'currency'">\r
        {{ formatCurrency(item.value) }}\r
      </span>\r
\r
      <!-- Percentage type -->\r
      <span *ngSwitchCase="'percentage'">\r
        {{ item.value }}%\r
      </span>\r
\r
      <!-- Link type -->\r
      <a *ngSwitchCase="'link'"\r
         [href]="item.href || '#'"\r
...
//# sourceMappingURL=chunk-RISUZMFK.js.map

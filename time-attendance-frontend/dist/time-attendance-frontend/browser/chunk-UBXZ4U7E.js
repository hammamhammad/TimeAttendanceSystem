...
function EditAttendanceComponent_Conditional_4_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
...
__name(EditAttendanceComponent_Conditional_4_Conditional_34_Template, "EditAttendanceComponent_Conditional_4_Conditional_34_Template");
function EditAttendanceComponent_Conditional_4_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(EditAttendanceComponent_Conditional_4_Conditional_42_Template, "EditAttendanceComponent_Conditional_4_Conditional_42_Template");
function EditAttendanceComponent_Conditional_4_Conditional_43_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(EditAttendanceComponent_Conditional_4_Conditional_43_Conditional_6_Template, "EditAttendanceComponent_Conditional_4_Conditional_43_Conditional_6_Template");
function EditAttendanceComponent_Conditional_4_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, EditAttendanceComponent_Conditional_4_Conditional_43_Conditional_6_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
__name(EditAttendanceComponent_Conditional_4_Conditional_43_Template, "EditAttendanceComponent_Conditional_4_Conditional_43_Template");
function EditAttendanceComponent_Conditional_4_Conditional_119_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(EditAttendanceComponent_Conditional_4_Conditional_119_Template, "EditAttendanceComponent_Conditional_4_Conditional_119_Template");
function EditAttendanceComponent_Conditional_4_Conditional_128_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(EditAttendanceComponent_Conditional_4_Conditional_128_Template, "EditAttendanceComponent_Conditional_4_Conditional_128_Template");
function EditAttendanceComponent_Conditional_4_Conditional_140_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 49);
  }
}
__name(EditAttendanceComponent_Conditional_4_Conditional_140_Template, "EditAttendanceComponent_Conditional_4_Conditional_140_Template");
function EditAttendanceComponent_Conditional_4_Conditional_141_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 50)(1, "span", 5);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
__name(EditAttendanceComponent_Conditional_4_Conditional_141_Template, "EditAttendanceComponent_Conditional_4_Conditional_141_Template");
function EditAttendanceComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(19, "div", 11)(20, "div", 15)(21, "div", 16)(22, "div", 17)(23, "h5", 18);
    \u0275\u0275element(24, "i", 19);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(26, "div", 10)(27, "div", 20)(28, "label", 21);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(33, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(34, EditAttendanceComponent_Conditional_4_Conditional_34_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(41, "date");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(42, EditAttendanceComponent_Conditional_4_Conditional_42_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(43, EditAttendanceComponent_Conditional_4_Conditional_43_Template, 7, 7, "div", 20);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(44, "div", 15)(45, "div", 16)(46, "div", 17)(47, "h5", 18);
    \u0275\u0275element(48, "i", 27);
    \u0275\u0275text(49);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "small", 28);
    \u0275\u0275text(51);
    \u0275\u0275elementEnd();
    \u0275\u0275element(52, "br");
    \u0275\u0275elementStart(53, "small", 29);
    \u0275\u0275text(54, "Uses backend business logic including flexible hours");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div", 10)(56, "div", 20)(57, "label", 30);
    \u0275\u0275text(58);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(59, "div", 31)(60, "strong");
    \u0275\u0275text(61);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "small", 32);
    \u0275\u0275text(63);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(64, "div", 20)(65, "label", 30);
    \u0275\u0275text(66);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "div", 31)(68, "strong");
    \u0275\u0275text(69);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "small", 32);
    \u0275\u0275text(71);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(72, "div", 20)(73, "label", 30);
    \u0275\u0275text(74);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "div", 31)(76, "strong");
    \u0275\u0275text(77);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "small", 32);
    \u0275\u0275text(79);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(80, "div", 20)(81, "label", 30);
    \u0275\u0275text(82);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "div", 31)(84, "strong");
    \u0275\u0275text(85);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(86, "small", 32);
    \u0275\u0275text(87);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(88, "div", 20)(89, "label", 30);
    \u0275\u0275text(90);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "div", 33)(92, "strong", 34);
    \u0275\u0275text(93);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(94, "small", 32);
    \u0275\u0275text(95);
    \u0275\u0275elementEnd()()()()()()();
    \u0275\u0275elementStart(96, "div", 11)(97, "div", 8)(98, "div", 16)(99, "div", 17)(100, "h5", 18);
    \u0275\u0275element(101, "i", 35);
    \u0275\u0275text(102);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(103, "div", 10)(104, "div", 11)(105, "div", 36)(106, "div", 37);
    \u0275\u0275element(107, "input", 38);
    \u0275\u0275elementStart(108, "label", 39);
    \u0275\u0275text(109);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(110, "div", 23);
    \u0275\u0275text(111);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(112, "div", 11)(113, "div", 36)(114, "div", 20)(115, "label", 40);
    \u0275\u0275text(116);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(117, "textarea", 41);
    \u0275\u0275text(118, "                    ");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(119, EditAttendanceComponent_Conditional_4_Conditional_119_Template, 2, 1, "div", 24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(120, "div", 36)(121, "div", 20)(122, "label", 42);
    \u0275\u0275text(123);
    \u0275\u0275elementStart(124, "span", 43);
    \u0275\u0275text(125, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(126, "textarea", 44);
    \u0275\u0275text(127, "                    ");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(128, EditAttendanceComponent_Conditional_4_Conditional_128_Template, 2, 1, "div", 24);
    \u0275\u0275elementStart(129, "div", 23);
    \u0275\u0275text(130);
    \u0275\u0275elementEnd()()()()()()()();
    \u0275\u0275elementStart(131, "div", 11)(132, "div", 8)(133, "div", 9)(134, "div", 10)(135, "div", 45)(136, "button", 46);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function EditAttendanceComponent_Conditional_4_Template_button_click_136_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onCancel());
    }, "EditAttendanceComponent_Conditional_4_Template_button_click_136_listener"));
    \u0275\u0275element(137, "i", 47);
    \u0275\u0275text(138);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(139, "button", 48);
    \u0275\u0275conditionalCreate(140, EditAttendanceComponent_Conditional_4_Conditional_140_Template, 1, 0, "i", 49);
    \u0275\u0275conditionalCreate(141, EditAttendanceComponent_Conditional_4_Conditional_141_Template, 3, 1, "div", 50);
    \u0275\u0275text(142);
    \u0275\u0275elementEnd()()()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", ctx_r0.i18n.t("attendance.edit.basic_info"), " ");
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", ctx_r0.i18n.t("attendance.edit.original"), ": ", ((tmp_12_0 = ctx_r0.attendanceRecord()) == null ? null : tmp_12_0.actualCheckInTime) ? \u0275\u0275pipeBind2(33, 72, (tmp_12_0 = ctx_r0.attendanceRecord()) == null ? null : tmp_12_0.actualCheckInTime, "HH:mm") : "--:--", " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.hasControlError("actualCheckInTime") ? 34 : -1);
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", ctx_r0.i18n.t("attendance.edit.original"), ": ", ((tmp_16_0 = ctx_r0.attendanceRecord()) == null ? null : tmp_16_0.actualCheckOutTime) ? \u0275\u0275pipeBind2(41, 75, (tmp_16_0 = ctx_r0.attendanceRecord()) == null ? null : tmp_16_0.actualCheckOutTime, "HH:mm") : "--:--", " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.hasControlError("actualCheckOutTime") ? 42 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.shiftHasBreak() ? 43 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", ctx_r0.i18n.t("attendance.edit.hours_calculations"), " ");
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", ctx_r0.i18n.t("attendance.edit.notes"), " ");
    \u0275\u0275advance(7);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.hasControlError("notes") ? 119 : -1);
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.hasControlError("overrideNotes") ? 128 : -1);
    \u0275\u0275advance(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.saving() ? 140 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.saving() ? 141 : -1);
    \u0275\u0275advance();
...
__publicField(_EditAttendanceComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditAttendanceComponent, selectors: [["app-edit-attendance"]], decls: 5, vars: 6, consts: [[1, "container-fluid"], ["mode", "edit", "moduleName", "attendance", "moduleRoute", "attendance", 3, "title", "entityId", "loading"], [1, "d-flex", "justify-content-center", "align-items-center", 2, "min-height", "200px"], ["role", "alert", 1, "alert", "alert-danger"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "fas", "fa-exclamation-triangle", "me-2"], [1, "row", "mb-4"], [1, "col-12"], [1, "card"], [1, "card-body"], [1, "row"], [1, "col-md-4"], [3, "status", "variant"], [3, "ngSubmit", "formGroup"], [1, "col-lg-6"], [1, "card", "mb-4"], [1, "card-header"], [1, "card-title", "mb-0"], [1, "fas", "fa-clock", "me-2"], [1, "mb-3"], ["for", "actualCheckInTime", 1, "form-label"], ["type", "time", "id", "actualCheckInTime", "formControlName", "actualCheckInTime", 1, "form-control"], [1, "form-text"], [1, "invalid-feedback"], ["for", "actualCheckOutTime", 1, "form-label"], ["type", "time", "id", "actualCheckOutTime", "formControlName", "actualCheckOutTime", 1, "form-control"], [1, "fas", "fa-calculator", "me-2"], [1, "text-muted"], [1, "text-info"], [1, "form-label"], [1, "form-control-plaintext", "bg-light", "p-2", "rounded"], [1, "text-muted", "ms-2"], [1, "form-control-plaintext", "bg-warning", "bg-opacity-10", "p-2", "rounded", "border", "border-warning"], [1, "text-warning"], [1, "fas", "fa-sticky-note", "me-2"], [1, "col-md-6"], [1, "form-check", "mb-3"], ["type", "checkbox", "id", "isApproved", "formControlName", "isApproved", 1, "form-check-input"], ["for", "isApproved", 1, "form-check-label"], ["for", "notes", 1, "form-label"], ["id", "notes", "formControlName", "notes", "rows", "3", 1, "form-control", 3, "placeholder"], ["for", "overrideNotes", 1, "form-label"], [1, "text-danger"], ["id", "overrideNotes", "formControlName", "overrideNotes", "rows", "3", 1, "form-control", 3, "placeholder"], [1, "d-flex", "justify-content-between"], ["type", "button", 1, "btn", "btn-outline-secondary", 3, "click"], [1, "fas", "fa-times", "me-2"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [1, "fas", "fa-save", "me-2"], ["role", "status", 1, "spinner-border", "spinner-border-sm", "me-2"], ["for", "breakHours", 1, "form-label"], ["type", "number", "id", "breakHours", "formControlName", "breakHours", "step", "0.1", 1, "form-control"]], template: /* @__PURE__ */ __name(function EditAttendanceComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(4, EditAttendanceComponent_Conditional_4_Template, 143, 78);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EditAttendanceComponent, [{
    type: Component,
    args: [{ selector: "app-edit-attendance", standalone: true, imports: [CommonModule, ReactiveFormsModule, FormHeaderComponent, StatusBadgeComponent], template: `<div class="container-fluid">\r
  <app-form-header\r
    mode="edit"\r
          ...
          <div class="card mb-4">\r
            <div class="card-header">\r
              <h5 class="card-title mb-0">\r
                ...
                {{ i18n.t('attendance.edit.basic_info') }}\r
              </h5>\r
            </div>\r
            <div class="card-body">\r
              <!-- Check-in Time -->\r
...
\r
        ...
        <div class="col-lg-6">\r
          <div class="card mb-4">\r
            <div class="card-header">\r
              <h5 class="card-title mb-0">\r
                <i class="fas fa-calculator me-2"></i>\r
                {{ i18n.t('attendance.edit.hours_calculations') }}\r
              </h5>\r
          ...
          <div class="card mb-4">\r
            <div class="card-header">\r
              <h5 class="card-title mb-0">\r
                ...
                {{ i18n.t('attendance.edit.notes') }}\r
              </h5>\r
            </div>\r
            <div class="card-body">\r
              <div class="row">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditAttendanceComponent, { className: "EditAttendanceComponent", filePath: "src/app/pages/attendance/edit-attendance/edit-attendance.component.ts", lineNumber: 23 });
})();
export {
  EditAttendanceComponent
};
//# sourceMappingURL=chunk-UBXZ4U7E.js.map

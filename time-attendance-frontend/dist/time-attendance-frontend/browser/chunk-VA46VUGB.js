...
}, "ViewUserComponent_Template"), dependencies: [CommonModule, HasPermissionDirective, FormHeaderComponent, LoadingSpinnerComponent, BadgeListComponent, DefinitionListComponent], styles: ["\n\n.avatar-sm[_ngcontent-%COMP%] {\n  width: 2.5rem;\n  height: 2.5rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.avatar-title[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-weight: 600;\n}\n/*# sourceMappingURL=view-user.component.css.map */"] }));
var ViewUserComponent = _ViewUserComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ViewUserComponent, [{
    type: Component,
    args: [{ selector: "app-view-user", standalone: true, imports: [CommonModule, HasPermissionDirective, FormHeaderComponent, LoadingSpinnerComponent, StatusBadgeComponent, BadgeListComponent, DefinitionListComponent], template: `<div class="container-fluid">
  <!-- Header -->
  <app-form-header
    mode="view"
...
//# sourceMappingURL=chunk-VA46VUGB.js.map

...
function EditShiftComponent_Conditional_5_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "label", 67);
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "span", 17);
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 56)(6, "input", 68);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_40_Template_input_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.requiredHours, $event) || (ctx_r0.shiftForm.requiredHours = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_40_Template_input_ngModelChange_6_listener"));
    \u0275\u0275elementEnd();
...
__name(EditShiftComponent_Conditional_5_Conditional_40_Template, "EditShiftComponent_Conditional_5_Conditional_40_Template");
function EditShiftComponent_Conditional_5_Conditional_89_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 74);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_89_Conditional_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.addShiftPeriod());
    }, "EditShiftComponent_Conditional_5_Conditional_89_Conditional_4_Template_button_click_0_listener"));
    \u0275\u0275element(1, "i", 75);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
...
__name(EditShiftComponent_Conditional_5_Conditional_89_Conditional_4_Template, "EditShiftComponent_Conditional_5_Conditional_89_Conditional_4_Template");
function EditShiftComponent_Conditional_5_Conditional_89_For_6_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 84);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_89_For_6_Conditional_9_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const $index_r7 = \u0275\u0275nextContext().$index;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.removeShiftPeriod($index_r7));
    }, "EditShiftComponent_Conditional_5_Conditional_89_For_6_Conditional_9_Template_button_click_0_listener"));
    \u0275\u0275element(1, "i", 85);
    \u0275\u0275elementEnd();
  }
}
__name(EditShiftComponent_Conditional_5_Conditional_89_For_6_Conditional_9_Template, "EditShiftComponent_Conditional_5_Conditional_89_For_6_Conditional_9_Template");
function EditShiftComponent_Conditional_5_Conditional_89_For_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 71)(1, "div", 76)(2, "span", 28);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, EditShiftComponent_Conditional_5_Conditional_89_For_6_Conditional_9_Template, 2, 0, "button", 80);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 81)(11, "div", 2)(12, "div", 24)(13, "label", 82);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "input", 83);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_89_For_6_Template_input_ngModelChange_15_listener($event) {
      const period_r8 = \u0275\u0275restoreView(_r5).$implicit;
      \u0275\u0275twoWayBindingSet(period_r8.startTime, $event) || (period_r8.startTime = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_89_For_6_Template_input_ngModelChange_15_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 24)(17, "label", 82);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "input", 83);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_89_For_6_Template_input_ngModelChange_19_listener($event) {
      const period_r8 = \u0275\u0275restoreView(_r5).$implicit;
      \u0275\u0275twoWayBindingSet(period_r8.endTime, $event) || (period_r8.endTime = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_89_For_6_Template_input_ngModelChange_19_listener"));
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
__name(EditShiftComponent_Conditional_5_Conditional_89_For_6_Template, "EditShiftComponent_Conditional_5_Conditional_89_For_6_Template");
function EditShiftComponent_Conditional_5_Conditional_89_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "app-form-section", 13)(1, "div", 14)(2, "div", 3)(3, "div", 69);
    \u0275\u0275conditionalCreate(4, EditShiftComponent_Conditional_5_Conditional_89_Conditional_4_Template, 3, 1, "button", 70);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(5, EditShiftComponent_Conditional_5_Conditional_89_For_6_Template, 20, 12, "div", 71, \u0275\u0275repeaterTrackByIndex);
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("title", ctx_r0.t("shifts.periods"));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r0.shiftForm.shiftPeriods.length < 2 ? 4 : -1);
    \u0275\u0275advance();
...
__name(EditShiftComponent_Conditional_5_Conditional_89_Template, "EditShiftComponent_Conditional_5_Conditional_89_Template");
function EditShiftComponent_Conditional_5_Conditional_99_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "label", 86);
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "span", 17);
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "input", 87);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_99_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r0 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.coreStart, $event) || (ctx_r0.shiftForm.coreStart = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_99_Template_input_ngModelChange_5_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 15)(7, "label", 88);
    \u0275\u0275text(8);
    \u0275\u0275elementStart(9, "span", 17);
    \u0275\u0275text(10, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "input", 89);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_99_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r0 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.coreEnd, $event) || (ctx_r0.shiftForm.coreEnd = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_99_Template_input_ngModelChange_11_listener"));
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
__name(EditShiftComponent_Conditional_5_Conditional_99_Template, "EditShiftComponent_Conditional_5_Conditional_99_Template");
function EditShiftComponent_Conditional_5_Conditional_125_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "label", 94);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 56)(4, "input", 95);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_125_Conditional_16_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext(3);
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.flexMinutesBefore, $event) || (ctx_r0.shiftForm.flexMinutesBefore = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_125_Conditional_16_Template_input_ngModelChange_4_listener"));
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 15)(10, "label", 96);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 56)(13, "input", 97);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_125_Conditional_16_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r0 = \u0275\u0275nextContext(3);
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.flexMinutesAfter, $event) || (ctx_r0.shiftForm.flexMinutesAfter = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_125_Conditional_16_Template_input_ngModelChange_13_listener"));
    \u0275\u0275elementEnd();
...
__name(EditShiftComponent_Conditional_5_Conditional_125_Conditional_16_Template, "EditShiftComponent_Conditional_5_Conditional_125_Conditional_16_Template");
function EditShiftComponent_Conditional_5_Conditional_125_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "label", 90);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 56)(4, "input", 91);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_125_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.gracePeriodMinutes, $event) || (ctx_r0.shiftForm.gracePeriodMinutes = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_125_Template_input_ngModelChange_4_listener"));
    \u0275\u0275listener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_125_Template_input_ngModelChange_4_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 21)(10, "div", 51)(11, "input", 92);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_125_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.allowFlexibleHours, $event) || (ctx_r0.shiftForm.allowFlexibleHours = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Conditional_125_Template_input_ngModelChange_11_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Conditional_125_Template_input_change_11_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.onFlexibleHoursChange());
    }, "EditShiftComponent_Conditional_5_Conditional_125_Template_input_change_11_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "label", 93);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 54);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(16, EditShiftComponent_Conditional_5_Conditional_125_Conditional_16_Template, 18, 8);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
...
__name(EditShiftComponent_Conditional_5_Conditional_125_Template, "EditShiftComponent_Conditional_5_Conditional_125_Template");
function EditShiftComponent_Conditional_5_Conditional_126_For_9_Template(rf, ctx) {
  if (rf & 1) {
...
__name(EditShiftComponent_Conditional_5_Conditional_126_For_9_Template, "EditShiftComponent_Conditional_5_Conditional_126_For_9_Template");
function EditShiftComponent_Conditional_5_Conditional_126_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 3)(2, "div", 98)(3, "div", 99);
    \u0275\u0275element(4, "i", 100);
    \u0275\u0275elementStart(5, "div")(6, "h6", 101);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(8, EditShiftComponent_Conditional_5_Conditional_126_For_9_Template, 2, 1, "div", 102, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
__name(EditShiftComponent_Conditional_5_Conditional_126_Template, "EditShiftComponent_Conditional_5_Conditional_126_Template");
function EditShiftComponent_Conditional_5_Conditional_134_Template(rf, ctx) {
  if (rf & 1) {
...
__name(EditShiftComponent_Conditional_5_Conditional_134_Template, "EditShiftComponent_Conditional_5_Conditional_134_Template");
function EditShiftComponent_Conditional_5_Conditional_135_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 104);
    \u0275\u0275text(1);
  }
...
__name(EditShiftComponent_Conditional_5_Conditional_135_Template, "EditShiftComponent_Conditional_5_Conditional_135_Template");
function EditShiftComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(4, "app-form-section", 13)(5, "div", 14)(6, "div", 15)(7, "label", 16);
    \u0275\u0275text(8);
    \u0275\u0275elementStart(9, "span", 17);
    \u0275\u0275text(10, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "input", 18);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.name, $event) || (ctx_r0.shiftForm.name = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_11_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 15)(13, "label", 19);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "app-searchable-select", 20);
    \u0275\u0275listener("selectionChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_app_searchable_select_selectionChange_15_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onStatusSelectionChange($event));
    }, "EditShiftComponent_Conditional_5_Template_app_searchable_select_selectionChange_15_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 21)(17, "label", 22);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "textarea", 23);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_textarea_ngModelChange_19_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.description, $event) || (ctx_r0.shiftForm.description = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_textarea_ngModelChange_19_listener"));
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(20, "app-form-section", 13)(21, "div", 14)(22, "div", 21)(23, "div", 2)(24, "div", 24)(25, "div", 25)(26, "input", 26);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_26_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.shiftType, $event) || (ctx_r0.shiftForm.shiftType = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_26_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_change_26_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onShiftTypeChange());
    }, "EditShiftComponent_Conditional_5_Template_input_change_26_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "label", 27)(28, "div", 28);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "small", 29);
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(32, "div", 24)(33, "div", 25)(34, "input", 30);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_34_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.shiftType, $event) || (ctx_r0.shiftForm.shiftType = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_34_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_change_34_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onShiftTypeChange());
    }, "EditShiftComponent_Conditional_5_Template_input_change_34_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "label", 31)(36, "div", 28);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "small", 29);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275conditionalCreate(40, EditShiftComponent_Conditional_5_Conditional_40_Template, 11, 4, "div", 15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "app-form-section", 13)(42, "div", 14)(43, "div", 21)(44, "div", 2)(45, "div", 32)(46, "div", 33)(47, "input", 34);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_47_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isSunday, $event) || (ctx_r0.shiftForm.isSunday = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_47_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "label", 35);
    \u0275\u0275text(49);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(50, "div", 32)(51, "div", 33)(52, "input", 36);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_52_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isMonday, $event) || (ctx_r0.shiftForm.isMonday = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_52_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "label", 37);
    \u0275\u0275text(54);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(55, "div", 32)(56, "div", 33)(57, "input", 38);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_57_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isTuesday, $event) || (ctx_r0.shiftForm.isTuesday = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_57_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "label", 39);
    \u0275\u0275text(59);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(60, "div", 32)(61, "div", 33)(62, "input", 40);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_62_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isWednesday, $event) || (ctx_r0.shiftForm.isWednesday = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_62_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "label", 41);
    \u0275\u0275text(64);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(65, "div", 32)(66, "div", 33)(67, "input", 42);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_67_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isThursday, $event) || (ctx_r0.shiftForm.isThursday = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_67_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "label", 43);
    \u0275\u0275text(69);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(70, "div", 32)(71, "div", 33)(72, "input", 44);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_72_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isFriday, $event) || (ctx_r0.shiftForm.isFriday = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_72_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "label", 45);
    \u0275\u0275text(74);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(75, "div", 32)(76, "div", 33)(77, "input", 46);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_77_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isSaturday, $event) || (ctx_r0.shiftForm.isSaturday = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_77_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "label", 47);
    \u0275\u0275text(79);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(80, "small", 29);
    \u0275\u0275text(81);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(82, "div", 48)(83, "div", 33)(84, "input", 49);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_84_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isNightShift, $event) || (ctx_r0.shiftForm.isNightShift = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_84_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "label", 50);
    \u0275\u0275text(86);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(87, "small", 29);
    \u0275\u0275text(88);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(89, EditShiftComponent_Conditional_5_Conditional_89_Template, 13, 4, "app-form-section", 13);
    \u0275\u0275elementStart(90, "app-form-section", 13)(91, "div", 14)(92, "div", 21)(93, "div", 51)(94, "input", 52);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_94_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.hasCoreHours, $event) || (ctx_r0.shiftForm.hasCoreHours = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_94_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_change_94_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onCoreHoursChange());
    }, "EditShiftComponent_Conditional_5_Template_input_change_94_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "label", 53);
    \u0275\u0275text(96);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(97, "div", 54);
    \u0275\u0275text(98);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(99, EditShiftComponent_Conditional_5_Conditional_99_Template, 12, 4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(100, "app-form-section", 13)(101, "div", 14)(102, "div", 15)(103, "label", 55);
    \u0275\u0275text(104);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "div", 56)(106, "input", 57);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(107, "span", 58);
    \u0275\u0275text(108);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(109, "div", 54);
    \u0275\u0275text(110);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(111, "div", 15)(112, "div", 51)(113, "input", 59);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_113_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isCheckInRequired, $event) || (ctx_r0.shiftForm.isCheckInRequired = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_113_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(114, "label", 60);
    \u0275\u0275text(115);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(116, "div", 54);
    \u0275\u0275text(117);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(118, "div", 15)(119, "div", 51)(120, "input", 61);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_input_ngModelChange_120_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.shiftForm.isAutoCheckOut, $event) || (ctx_r0.shiftForm.isAutoCheckOut = $event);
      return \u0275\u0275resetView($event);
    }, "EditShiftComponent_Conditional_5_Template_input_ngModelChange_120_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(121, "label", 62);
    \u0275\u0275text(122);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(123, "div", 54);
    \u0275\u0275text(124);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(125, EditShiftComponent_Conditional_5_Conditional_125_Template, 17, 8);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(126, EditShiftComponent_Conditional_5_Conditional_126_Template, 10, 1, "div", 14);
    \u0275\u0275elementStart(127, "div", 2)(128, "div", 3);
    \u0275\u0275element(129, "hr", 63);
    \u0275\u0275elementStart(130, "div", 64)(131, "button", 65);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function EditShiftComponent_Conditional_5_Template_button_click_131_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onCancel());
    }, "EditShiftComponent_Conditional_5_Template_button_click_131_listener"));
    \u0275\u0275text(132);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(133, "button", 66);
    \u0275\u0275conditionalCreate(134, EditShiftComponent_Conditional_5_Conditional_134_Template, 2, 1)(135, EditShiftComponent_Conditional_5_Conditional_135_Template, 2, 1);
    \u0275\u0275elementEnd()()()()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275property("title", ctx_r0.t("common.basicInformation"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx_r0.t("shifts.type"));
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.shiftForm.shiftType === ctx_r0.ShiftType.HoursOnly ? 40 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx_r0.t("shifts.workingDays"));
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.shiftForm.shiftType === ctx_r0.ShiftType.TimeBased ? 89 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx_r0.t("shifts.coreHours"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.shiftForm.hasCoreHours ? 99 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx_r0.t("shifts.advancedOptions"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.shiftForm.shiftType === ctx_r0.ShiftType.TimeBased ? 125 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r0.isFormValid() && ctx_r0.shiftForm.name ? 126 : -1);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.submitting() ? 134 : 135);
  }
}
...
__publicField(_EditShiftComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EditShiftComponent, selectors: [["app-edit-shift"]], decls: 6, vars: 4, consts: [["formRef", "ngForm"], [1, "container-fluid", "px-4"], [1, "row"], [1, "col-12"], ["mode", "edit", "moduleName", "shifts", "moduleRoute", "shifts", 3, "title", "entityId", "loading"], [1, "d-flex", "justify-content-center", "align-items-center", 2, "height", "400px"], [1, "card", "border-0", "shadow-sm"], [1, "text-center"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "mt-3", "text-muted"], [1, "card-body", "p-4"], [3, "ngSubmit"], [3, "title"], [1, "row", "mb-4"], [1, "col-md-6", "mb-3"], ["for", "name", 1, "form-label"], [1, "text-danger"], ["type", "text", "id", "name", "name", "name", "required", "", "maxlength", "200", 1, "form-control", 3, "ngModelChange", "ngModel", "placeholder"], ["for", "status", 1, "form-label"], [3, "selectionChange", "options", "ngModel", "ngModelOptions", "searchable", "clearable"], [1, "col-12", "mb-3"], ["for", "description", 1, "form-label"], ["id", "description", "name", "description", "rows", "3", "maxlength", "1000", 1, "form-control", 3, "ngModelChange", "ngModel", "placeholder"], [1, "col-md-6"], [1, "form-check", "p-3", "border", "rounded"], ["type", "radio", "name", "shiftType", "id", "timeBased", 1, "form-check-input", 3, "ngModelChange", "change", "value", "ngModel"], ["for", "timeBased", 1, "form-check-label", "w-100"], [1, "fw-medium"], [1, "text-muted"], ["type", "radio", "name", "shiftType", "id", "hoursOnly", 1, "form-check-input", 3, "ngModelChange", "change", "value", "ngModel"], ["for", "hoursOnly", 1, "form-check-label", "w-100"], [1, "col-md-3", "col-6", "mb-2"], [1, "form-check"], ["type", "checkbox", "id", "sunday", "name", "isSunday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "sunday", 1, "form-check-label"], ["type", "checkbox", "id", "monday", "name", "isMonday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "monday", 1, "form-check-label"], ["type", "checkbox", "id", "tuesday", "name", "isTuesday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "tuesday", 1, "form-check-label"], ["type", "checkbox", "id", "wednesday", "name", "isWednesday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "wednesday", 1, "form-check-label"], ["type", "checkbox", "id", "thursday", "name", "isThursday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "thursday", 1, "form-check-label"], ["type", "checkbox", "id", "friday", "name", "isFriday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "friday", 1, "form-check-label"], ["type", "checkbox", "id", "saturday", "name", "isSaturday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "saturday", 1, "form-check-label"], [1, "col-12", "mt-3"], ["type", "checkbox", "id", "nightShift", "name", "isNightShift", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "nightShift", 1, "form-check-label", "fw-medium"], [1, "form-check", "form-switch"], ["type", "checkbox", "id", "hasCoreHours", "name", "hasCoreHours", 1, "form-check-input", 3, "ngModelChange", "change", "ngModel"], ["for", "hasCoreHours", 1, "form-check-label"], [1, "form-text"], ["for", "requiredWeeklyHours", 1, "form-label"], [1, "input-group"], ["type", "number", "id", "requiredWeeklyHours", "name", "requiredWeeklyHours", "step", "0.5", "min", "0", "max", "168", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "input-group-text"], ["type", "checkbox", "id", "checkInRequired", "name", "isCheckInRequired", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "checkInRequired", 1, "form-check-label"], ["type", "checkbox", "id", "autoCheckOut", "name", "isAutoCheckOut", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "autoCheckOut", 1, "form-check-label"], [1, "mb-4"], [1, "d-flex", "justify-content-end", "gap-2"], ["type", "button", 1, "btn", "btn-outline-secondary", 3, "click", "disabled"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["for", "requiredHours", 1, "form-label"], ["type", "number", "id", "requiredHours", "name", "requiredHours", "step", "0.5", "min", "0.5", "max", "24", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "d-flex", "justify-content-end", "mb-3"], ["type", "button", 1, "btn", "btn-outline-primary", "btn-sm"], [1, "card", "border", "mb-3"], [1, "alert", "alert-info", "d-flex", "align-items-center"], [1, "bi", "bi-info-circle", "me-2"], ["type", "button", 1, "btn", "btn-outline-primary", "btn-sm", 3, "click"], [1, "bi", "bi-plus-circle", "me-1"], [1, "card-header", "bg-light", "d-flex", "justify-content-between", "align-items-center", "py-2"], [1, "d-flex", "align-items-center", "gap-2"], [1, "badge", 3, "ngClass"], [1, "text-muted", "small"], ["type", "button", 1, "btn", "btn-outline-danger", "btn-sm"], [1, "card-body"], [1, "form-label"], ["type", "time", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel", "name"], ["type", "button", 1, "btn", "btn-outline-danger", "btn-sm", 3, "click"], [1, "bi", "bi-trash"], ["for", "coreStart", 1, "form-label"], ["type", "time", "id", "coreStart", "name", "coreStart", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "coreEnd", 1, "form-label"], ["type", "time", "id", "coreEnd", "name", "coreEnd", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "gracePeriod", 1, "form-label"], ["type", "number", "id", "gracePeriod", "name", "gracePeriodMinutes", "min", "0", "max", "120", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "checkbox", "id", "flexibleHours", "name", "allowFlexibleHours", 1, "form-check-input", 3, "ngModelChange", "change", "ngModel"], ["for", "flexibleHours", 1, "form-check-label"], ["for", "flexBefore", 1, "form-label"], ["type", "number", "id", "flexBefore", "name", "flexMinutesBefore", "min", "1", "max", "480", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "flexAfter", 1, "form-label"], ["type", "number", "id", "flexAfter", "name", "flexMinutesAfter", "min", "1", "max", "480", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "alert", "alert-danger"], [1, "d-flex", "align-items-start"], [1, "bi", "bi-exclamation-triangle", "me-2", "mt-1"], [1, "alert-heading", "mb-2"], [1, "mb-1"], ["role", "status", "aria-hidden", "true", 1, "spinner-border", "spinner-border-sm", "me-2"], [1, "bi", "bi-check-circle", "me-2"]], template: /* @__PURE__ */ __name(function EditShiftComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(4, EditShiftComponent_Conditional_4_Template, 7, 2, "div", 5)(5, EditShiftComponent_Conditional_5_Template, 136, 68, "div", 6);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
...
\r
      <!-- Loading State -->\r
      @if (loading()) {\r
        <div class="d-flex justify-content-center align-items-center" style="height: 400px;">\r
          <div class="text-center">\r
            <div class="spinner-border text-primary" role="status">\r
              <span class="visually-hidden">{{ t('common.loading') }}</span>\r
            </div>\r
            <div class="mt-3 text-muted">{{ t('shifts.loading.shift') }}</div>\r
          </div>\r
        </div>\r
      } @else {\r
\r
...
\r
              ...
              <app-form-section [title]="t('common.basicInformation')">\r
                <div class="row mb-4">\r
                  <!-- Shift Name -->\r
                  <div class="col-md-6 mb-3">\r
                  <label for="name" class="form-label">\r
                    {{ t('shifts.name') }} <span class="text-danger">*</span>\r
                  </label>\r
                  <input\r
                    type="text"\r
                    class="form-control"\r
                    id="name"\r
                    [(ngModel)]="shiftForm.name"\r
                    name="name"\r
                    required\r
                    maxlength="200"\r
                    placeholder="{{ t('shifts.namePlaceholder') }}">\r
                </div>\r
\r
                <!-- Status Field (Edit Only) -->\r
                <div class="col-md-6 mb-3">\r
                  <label for="status" class="form-label">{{ t('shifts.fields.status') }}</label>\r
                  <app-searchable-select\r
                    [options]="statusSelectOptions"\r
                    [ngModel]="shiftForm.status.toString()"\r
...
\r
                ...
                <div class="col-12 mb-3">\r
                  <label for="description" class="form-label">{{ t('shifts.description') }}</label>\r
                  <textarea\r
                    class="form-control"\r
                    id="description"\r
                    [(ngModel)]="shiftForm.description"\r
                    name="description"\r
                    rows="3"\r
                    maxlength="1000"\r
                    placeholder="{{ t('shifts.descriptionPlaceholder') }}"></textarea>\r
                </div>\r
                </div>\r
              </app-form-section>\r
\r
              <!-- Shift Type Section -->\r
              <app-form-section [title]="t('shifts.type')">\r
                <div class="row mb-4">\r
                  <!-- Shift Type Selection -->\r
                <div class="col-12 mb-3">\r
                  <div class="row">\r
                    <div class="col-md-6">\r
                      <div class="form-check p-3 border rounded">\r
                        <input\r
                          class="form-check-input"\r
                          type="radio"\r
                          name="shiftType"\r
                          id="timeBased"\r
                          [value]="ShiftType.TimeBased"\r
                          [(ngModel)]="shiftForm.shiftType"\r
                          (change)="onShiftTypeChange()">\r
                        <label class="form-check-label w-100" for="timeBased">\r
                          <div class="fw-medium">{{ t('shifts.types.timeBased') }}</div>\r
                          <small class="text-muted">{{ t('shifts.help.shiftType.timeBased') }}</small>\r
                        </label>\r
                      </div>\r
                    </div>\r
                    <div class="col-md-6">\r
                      <div class="form-check p-3 border rounded">\r
                        <input\r
                          ...
                          name="shiftType"\r
                          id="hoursOnly"\r
                          [value]="ShiftType.HoursOnly"\r
                          [(ngModel)]="shiftForm.shiftType"\r
                          (change)="onShiftTypeChange()">\r
                        <label class="form-check-label w-100" for="hoursOnly">\r
                          <div class="fw-medium">{{ t('shifts.types.hoursOnly') }}</div>\r
                          <small class="text-muted">{{ t('shifts.help.shiftType.hoursOnly') }}</small>\r
                        </label>\r
                      </div>\r
                    </div>\r
                  </div>\r
...
\r
                <!-- Required Hours (Hours-Only) -->\r
                @if (shiftForm.shiftType === ShiftType.HoursOnly) {\r
                  <div class="col-md-6 mb-3">\r
                    <label for="requiredHours" class="form-label">\r
                      {{ t('shifts.requiredHours') }} <span class="text-danger">*</span>\r
                    </label>\r
                    <div class="input-group">\r
                      <input\r
                        ...
                        class="form-control"\r
                        id="requiredHours"\r
                        [(ngModel)]="shiftForm.requiredHours"\r
                        name="requiredHours"\r
                        step="0.5"\r
                        min="0.5"\r
                        max="24"\r
                        required>\r
                      <span class="input-group-text">{{ t('shifts.hours') }}</span>\r
                    </div>\r
                    <div class="form-text">{{ t('shifts.help.requiredHours') }}</div>\r
                  </div>\r
                }\r
                </div>\r
              </app-form-section>\r
\r
              <!-- Working Days Section -->\r
              <app-form-section [title]="t('shifts.workingDays')">\r
                <div class="row mb-4">\r
                  <div class="col-12 mb-3">\r
                  <div class="row">\r
                    <div class="col-md-3 col-6 mb-2">\r
                      <div class="form-check">\r
                        <input\r
                          class="form-check-input"\r
                          type="checkbox"\r
                          id="sunday"\r
                          [(ngModel)]="shiftForm.isSunday"\r
                          name="isSunday">\r
                        <label class="form-check-label" for="sunday">{{ t('common.days.sunday') }}</label>\r
                      </div>\r
                    </div>\r
                    <div class="col-md-3 col-6 mb-2">\r
                      <div class="form-check">\r
                        <input\r
                          ...
                          type="checkbox"\r
                          id="monday"\r
                          [(ngModel)]="shiftForm.isMonday"\r
                          name="isMonday">\r
                        <label class="form-check-label" for="monday">{{ t('common.days.monday') }}</label>\r
                      </div>\r
                    </div>\r
                    <div class="col-md-3 col-6 mb-2">\r
                      <div class="form-check">\r
                        <input\r
                          ...
                          type="checkbox"\r
                          id="tuesday"\r
                          [(ngModel)]="shiftForm.isTuesday"\r
                          name="isTuesday">\r
                        <label class="form-check-label" for="tuesday">{{ t('common.days.tuesday') }}</label>\r
                      </div>\r
                    </div>\r
                    <div class="col-md-3 col-6 mb-2">\r
                      <div class="form-check">\r
                        <input\r
                          ...
                          type="checkbox"\r
                          id="wednesday"\r
                          [(ngModel)]="shiftForm.isWednesday"\r
                          name="isWednesday">\r
                        <label class="form-check-label" for="wednesday">{{ t('common.days.wednesday') }}</label>\r
                      </div>\r
                    </div>\r
                    <div class="col-md-3 col-6 mb-2">\r
                      <div class="form-check">\r
                        <input\r
                          ...
                          type="checkbox"\r
                          id="thursday"\r
                          [(ngModel)]="shiftForm.isThursday"\r
                          name="isThursday">\r
                        <label class="form-check-label" for="thursday">{{ t('common.days.thursday') }}</label>\r
                      </div>\r
                    </div>\r
                    <div class="col-md-3 col-6 mb-2">\r
                      <div class="form-check">\r
                        <input\r
                          ...
                          type="checkbox"\r
                          id="friday"\r
                          [(ngModel)]="shiftForm.isFriday"\r
                          name="isFriday">\r
                        <label class="form-check-label" for="friday">{{ t('common.days.friday') }}</label>\r
                      </div>\r
                    </div>\r
                    <div class="col-md-3 col-6 mb-2">\r
                      <div class="form-check">\r
                        <input\r
                          ...
                          type="checkbox"\r
                          id="saturday"\r
                          [(ngModel)]="shiftForm.isSaturday"\r
                          name="isSaturday">\r
                        <label class="form-check-label" for="saturday">{{ t('common.days.saturday') }}</label>\r
                      </div>\r
                    </div>\r
                  </div>\r
                  <small class="text-muted">{{ t('shifts.help.workingDays') }}</small>\r
                </div>\r
\r
                <!-- Night Shift -->\r
                <div class="col-12 mt-3">\r
                  <div class="form-check">\r
                    <input\r
                      class="form-check-input"\r
                      type="checkbox"\r
                      id="nightShift"\r
                      [(ngModel)]="shiftForm.isNightShift"\r
                      name="isNightShift">\r
                    <label class="form-check-label fw-medium" for="nightShift">\r
                      {{ t('shifts.isNightShift') }}\r
                    </label>\r
                  </div>\r
                  <small class="text-muted">{{ t('shifts.help.nightShift') }}</small>\r
                </div>\r
                </div>\r
              </app-form-section>\r
\r
              <!-- Work Periods Section (Time-Based Only) -->\r
              @if (shiftForm.shiftType === ShiftType.TimeBased) {\r
                <app-form-section [title]="t('shifts.periods')">\r
                  <div class="row mb-4">\r
                    <div class="col-12">\r
                      <div class="d-flex justify-content-end mb-3">\r
                        @if (shiftForm.shiftPeriods.length < 2) {\r
                          <button\r
                            type="button"\r
                            class="btn btn-outline-primary btn-sm"\r
                            (click)="addShiftPeriod()">\r
                            <i class="bi bi-plus-circle me-1"></i>{{ t('shifts.addPeriod') }}\r
                          </button>\r
                        }\r
                      </div>\r
\r
                    @for (period of shiftForm.shiftPeriods; track $index) {\r
                      <div class="card border mb-3">\r
                        <div class="card-header bg-light d-flex justify-content-between align-items-center py-2">\r
                          <span class="fw-medium">{{ t('shifts.period') }} {{ period.periodOrder }}</span>\r
                          <div class="d-flex align-items-center gap-2">\r
                            <span class="badge" [ngClass]="isNightShift(period.startTime, period.endTime) ? 'bg-info' : 'bg-primary'">\r
                              {{ getPeriodTypeText(period) }}\r
                            </span>\r
                            <span class="text-muted small">{{ formatHours(calculatePeriodHours(period.startTime, period.endTime)) }}</span>\r
                            @if (shiftForm.shiftPeriods.length > 1) {\r
                              <button\r
                                type="button"\r
                                class="btn btn-outline-danger btn-sm"\r
                                (click)="removeShiftPeriod($index)">\r
                        ...
                        <div class="card-body">\r
                          <div class="row">\r
                            <div class="col-md-6">\r
                              <label class="form-label">{{ t('shifts.startTime') }}</label>\r
                              <input\r
                                type="time"\r
                                class="form-control"\r
                                [(ngModel)]="period.startTime"\r
                                [name]="'startTime_' + $index"\r
                                required>\r
                            </div>\r
                            <div class="col-md-6">\r
                              <label class="form-label">{{ t('shifts.endTime') }}</label>\r
                              <input\r
                                type="time"\r
                                class="form-control"\r
                                [(ngModel)]="period.endTime"\r
                                [name]="'endTime_' + $index"\r
                                required>\r
                            </div>\r
                          </div>\r
                        </div>\r
...
\r
                    <!-- Total Hours Display -->\r
                    <div class="alert alert-info d-flex align-items-center">\r
                      <i class="bi bi-info-circle me-2"></i>\r
                      <span>{{ t('shifts.totalHours') }}: <strong>{{ formatHours(getTotalShiftHours()) }}</strong></span>\r
                    </div>\r
                    </div>\r
                  </div>\r
                </app-form-section>\r
...
\r
              <!-- Core Hours Section -->\r
              <app-form-section [title]="t('shifts.coreHours')">\r
                <div class="row mb-4">\r
                  <!-- Enable Core Hours -->\r
                <div class="col-12 mb-3">\r
                  <div class="form-check form-switch">\r
                    <input\r
                      ...
                      type="checkbox"\r
                      id="hasCoreHours"\r
                      [(ngModel)]="shiftForm.hasCoreHours"\r
                      name="hasCoreHours"\r
                      (change)="onCoreHoursChange()">\r
                    <label class="form-check-label" for="hasCoreHours">\r
                      {{ t('shifts.hasCoreHours') }}\r
                    </label>\r
                  </div>\r
                  <div class="form-text">{{ t('shifts.help.coreHours') }}</div>\r
                </div>\r
\r
                <!-- Core Hours Times -->\r
                @if (shiftForm.hasCoreHours) {\r
                  <div class="col-md-6 mb-3">\r
                    <label for="coreStart" class="form-label">\r
                      {{ t('shifts.coreStart') }} <span class="text-danger">*</span>\r
                    </label>\r
                    <input\r
                      type="time"\r
                      class="form-control"\r
                      id="coreStart"\r
                      [(ngModel)]="shiftForm.coreStart"\r
                      name="coreStart"\r
                      required>\r
                  </div>\r
\r
                  <div class="col-md-6 mb-3">\r
                    <label for="coreEnd" class="form-label">\r
                      {{ t('shifts.coreEnd') }} <span class="text-danger">*</span>\r
                    </label>\r
                    <input\r
                      type="time"\r
                      class="form-control"\r
                      id="coreEnd"\r
                      [(ngModel)]="shiftForm.coreEnd"\r
                      name="coreEnd"\r
                      required>\r
                  </div>\r
                }\r
...
\r
              <!-- Advanced Options Section -->\r
              <app-form-section [title]="t('shifts.advancedOptions')">\r
                <div class="row mb-4">\r
                  <!-- Weekly Hours -->\r
                <div class="col-md-6 mb-3">\r
                  <label for="requiredWeeklyHours" class="form-label">{{ t('shifts.requiredWeeklyHours') }}</label>\r
                  <div class="input-group">\r
                    <input\r
                      type="number"\r
                      class="form-control"\r
                      id="requiredWeeklyHours"\r
                      [(ngModel)]="shiftForm.requiredWeeklyHours"\r
                      name="requiredWeeklyHours"\r
                      step="0.5"\r
                      min="0"\r
                      max="168">\r
                    <span class="input-group-text">{{ t('shifts.hours') }}</span>\r
                  </div>\r
                  <div class="form-text">{{ t('shifts.help.requiredWeeklyHours') }}</div>\r
                </div>\r
\r
                <!-- Check-in Required -->\r
                <div class="col-md-6 mb-3">\r
                  <div class="form-check form-switch">\r
                    <input\r
                      class="form-check-input"\r
                      type="checkbox"\r
                      id="checkInRequired"\r
                      [(ngModel)]="shiftForm.isCheckInRequired"\r
                      name="isCheckInRequired">\r
                    <label class="form-check-label" for="checkInRequired">\r
                      {{ t('shifts.checkInRequired') }}\r
                    </label>\r
                  </div>\r
                  <div class="form-text">{{ t('shifts.help.checkInRequired') }}</div>\r
                </div>\r
\r
                <!-- Auto Check-out -->\r
                <div class="col-md-6 mb-3">\r
                  <div class="form-check form-switch">\r
                    <input\r
                      ...
                      type="checkbox"\r
                      id="autoCheckOut"\r
                      [(ngModel)]="shiftForm.isAutoCheckOut"\r
                      name="isAutoCheckOut">\r
                    <label class="form-check-label" for="autoCheckOut">\r
                      {{ t('shifts.autoCheckOut') }}\r
                    </label>\r
                  </div>\r
                  <div class="form-text">{{ t('shifts.help.autoCheckOut') }}</div>\r
                </div>\r
\r
                <!-- Grace Period (Time-Based Only) -->\r
                @if (shiftForm.shiftType === ShiftType.TimeBased) {\r
                  <div class="col-md-6 mb-3">\r
                    <label for="gracePeriod" class="form-label">{{ t('shifts.gracePeriodMinutes') }}</label>\r
                    <div class="input-group">\r
                      <input\r
                        type="number"\r
                        class="form-control"\r
                        id="gracePeriod"\r
                        [(ngModel)]="shiftForm.gracePeriodMinutes"\r
                        name="gracePeriodMinutes"\r
                        (ngModelChange)="onGracePeriodChange()"\r
                        min="0"\r
                        max="120">\r
                      <span class="input-group-text">{{ t('common.minutes') }}</span>\r
                    </div>\r
                    <div class="form-text">{{ t('shifts.help.gracePeriod') }}</div>\r
                  </div>\r
\r
                  <!-- Flexible Hours -->\r
                  <div class="col-12 mb-3">\r
                    <div class="form-check form-switch">\r
                      <input\r
                        ...
                        type="checkbox"\r
                        id="flexibleHours"\r
                        [(ngModel)]="shiftForm.allowFlexibleHours"\r
                        name="allowFlexibleHours"\r
                        (change)="onFlexibleHoursChange()">\r
                      <label class="form-check-label" for="flexibleHours">\r
                        {{ t('shifts.allowFlexibleHours') }}\r
                      </label>\r
                    </div>\r
                    <div class="form-text">{{ t('shifts.help.flexibleHours') }}</div>\r
                  </div>\r
\r
                  @if (shiftForm.allowFlexibleHours) {\r
                    <div class="col-md-6 mb-3">\r
                      <label for="flexBefore" class="form-label">{{ t('shifts.flexMinutesBefore') }}</label>\r
                      <div class="input-group">\r
                        <input\r
                          type="number"\r
                          class="form-control"\r
                          id="flexBefore"\r
                          [(ngModel)]="shiftForm.flexMinutesBefore"\r
                          name="flexMinutesBefore"\r
                          min="1"\r
                          max="480">\r
                        <span class="input-group-text">{{ t('common.minutes') }}</span>\r
                      </div>\r
                      <div class="form-text">{{ t('shifts.help.flexBefore') }}</div>\r
                    </div>\r
\r
                    <div class="col-md-6 mb-3">\r
                      <label for="flexAfter" class="form-label">{{ t('shifts.flexMinutesAfter') }}</label>\r
                      <div class="input-group">\r
                        <input\r
                          type="number"\r
                          class="form-control"\r
                          id="flexAfter"\r
                          [(ngModel)]="shiftForm.flexMinutesAfter"\r
                          name="flexMinutesAfter"\r
                          min="1"\r
                          max="480">\r
                        <span class="input-group-text">{{ t('common.minutes') }}</span>\r
                      </div>\r
                      <div class="form-text">{{ t('shifts.help.flexAfter') }}</div>\r
                    </div>\r
                  }\r
                }\r
                </div>\r
...
\r
              <!-- Validation Errors -->\r
              @if (!isFormValid() && shiftForm.name) {\r
                <div class="row mb-4">\r
                  <div class="col-12">\r
                    <div class="alert alert-danger">\r
                      <div class="d-flex align-items-start">\r
                        <i class="bi bi-exclamation-triangle me-2 mt-1"></i>\r
                        <div>\r
                          <h6 class="alert-heading mb-2">{{ t('common.validationErrors') }}</h6>\r
                          @for (error of getFormErrors(); track error) {\r
                            <div class="mb-1">\u2022 {{ error }}</div>\r
                          }\r
                        </div>\r
                      </div>\r
                    </div>\r
                ...
                <div class="col-12">\r
                  ...
                  <div class="d-flex justify-content-end gap-2">\r
                    ...
                    <button\r
                      ...
                      [disabled]="!isFormValid() || submitting()">\r
                      @if (submitting()) {\r
                        <span class="spinner-border spinner-border-sm me-2" role="status" aria-hidden="true"></span>\r
                        {{ t('shifts.loading.updating') }}\r
                      } @else {\r
                        <i class="bi bi-check-circle me-2"></i>{{ t('shifts.update') }}\r
                      }\r
                    </button>\r
                  </div>\r
                </div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditShiftComponent, { className: "EditShiftComponent", filePath: "src/app/pages/shifts/edit-shift/edit-shift.component.ts", lineNumber: 25 });
})();
export {
  EditShiftComponent
};
//# sourceMappingURL=chunk-PI6URAOL.js.map

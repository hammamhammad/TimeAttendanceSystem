      ...
      if (result.confirmed) {
        ...
        this.shiftsService.setDefaultShift(this.shift().id).subscribe({
          next: /* @__PURE__ */ __name(() => {
            this.notificationService.success(this.i18n.t("shifts.success.set_as_default"));
...
__publicField(_ViewShiftComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewShiftComponent, selectors: [["app-view-shift"]], decls: 5, vars: 6, consts: [[1, "app-view-page"], ["mode", "view", "moduleName", "shifts", "moduleRoute", "shifts", 3, "title", "entityId", "loading"], [1, "text-center", "py-5"], ["role", "alert", 1, "alert", "alert-danger"], [1, "app-desktop-sidebar"], [3, "message", "variant", "centered"], [1, "fas", "fa-exclamation-triangle", "me-2"], [1, "app-main-content"], ["icon", "fas fa-info-circle", "layout", "two-column", 3, "title", "fields"], ["icon", "fas fa-clock", "layout", "two-column", 1, "mt-4", 3, "title", "fields"], [1, "card", "mt-4"], ["icon", "fas fa-calendar-week", "layout", "two-column", 1, "mt-4", 3, "title", "fields"], ["icon", "fas fa-cogs", "layout", "two-column", 1, "mt-4", 3, "title", "fields"], ["icon", "fas fa-history", "layout", "two-column", 1, "mt-4", 3, "title", "fields"], [1, "app-sidebar-content"], [1, "card", "mb-3"], [1, "card-header"], [1, "card-title", "mb-0"], [1, "fas", "fa-chart-pie", "me-2"], [1, "card-body"], [1, "shift-summary"], [1, "summary-item"], [1, "summary-label"], [1, "summary-value"], [3, "status", "variant"], [1, "summary-value", "periods-count"], [1, "card"], [1, "fas", "fa-arrow-left", "me-2"], [1, "fas", "fa-calendar-day", "me-2"], [1, "shift-periods"], [1, "period-item", 3, "night-period"], [1, "total-hours", "mt-3"], [1, "period-item"], [1, "period-header"], [1, "period-order"], [1, "period-time"], [1, "badge", "bg-warning", "ms-2"], [1, "period-duration"], [1, "fas", "fa-clock", "me-1"], [1, "fas", "fa-cogs", "me-2"], [1, "d-grid", "gap-2"], ["type", "button", 1, "btn", "btn-warning", 3, "disabled"], ["type", "button", 1, "btn", "btn-outline-danger", 3, "disabled"], ["type", "button", 1, "btn", "btn-warning", 3, "click", "disabled"], ["role", "status", 1, "spinner-border", "spinner-border-sm", "me-2"], [1, "fas", "fa-star", "me-2"], ["type", "button", 1, "btn", "btn-outline-danger", 3, "click", "disabled"], [1, "fas", "fa-trash", "me-2"], [1, "summary-value", "hours-value"], ["icon", "fas fa-moon", 3, "status", "variant"]], template: /* @__PURE__ */ __name(function ViewShiftComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_1_0;
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx.i18n.t("shifts.view_shift"))("entityId", (tmp_1_0 = ctx.shift()) == null ? null : tmp_1_0.id)("loading", ctx.loading());
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ViewShiftComponent, { className: "ViewShiftComponent", filePath: "src/app/pages/shifts/view-shift/view-shift.component.ts", lineNumber: 30 });
})();
export {
  ViewShiftComponent
};
//# sourceMappingURL=chunk-QN5JTY2W.js.map

...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EditShiftComponent, [{
    type: Component,
    args: [{ selector: "app-edit-shift", standalone: true, imports: [CommonModule, FormsModule, SearchableSelectComponent, FormHeaderComponent, FormSectionComponent], template: `<div class="container-fluid px-4">
  <div class="row">
    <div class="col-12">
      <app-form-header
        mode="edit"
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body p-4">
            <form (ngSubmit)="onSubmit()" #formRef="ngForm">
              ...
              <app-form-section [title]="t('common.basicInformation')">
                <div class="row mb-4">
                  <!-- Shift Name -->
              ...
              <!-- Shift Type Section -->
              <app-form-section [title]="t('shifts.type')">
                <div class="row mb-4">
              ...
              <app-form-section [title]="t('shifts.workingDays')">
                <div class="row mb-4">
                  <div class="col-12 mb-3">
                  <div class="row">
              ...
              @if (shiftForm.shiftType === ShiftType.TimeBased) {
                <app-form-section [title]="t('shifts.periods')">
                  <div class="row mb-4">
                    <div class="col-12">
              ...
              <!-- Core Hours Section -->
              <app-form-section [title]="t('shifts.coreHours')">
                <div class="row mb-4">
                  <!-- Enable Core Hours -->
                <div class="col-12 mb-3">
              ...
              <app-form-section [title]="t('shifts.advancedOptions')">
                <div class="row mb-4">
                  <!-- Weekly Hours -->
                <div class="col-md-6 mb-3">
...
//# sourceMappingURL=chunk-QN5KCED5.js.map

...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DepartmentTableComponent, [{
    type: Component,
    args: [{ selector: "app-department-table", standalone: true, imports: [FormsModule, HasPermissionDirective, StatusBadgeComponent, LoadingSpinnerComponent], template: `<div class="department-table">
  <!-- Controls -->
  @if (showControls) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DepartmentTreeComponent, [{
    type: Component,
    args: [{ selector: "app-department-tree", standalone: true, imports: [FormsModule, LoadingSpinnerComponent], template: `<div class="department-tree">
  <!-- Controls -->
  @if (showControls) {
...
(() => {
  ...
  <!-- Page Header -->
  <app-page-header [title]="i18n.t('department.departments')">
  </app-page-header>

  <!-- Filters Component -->
  <app-unified-filter moduleName="departments" [refreshing]="branchesLoading()" (searchChange)="onSearchChange($event)"
    (filtersChange)="onFiltersChange($event)" (add)="onDepartmentAdd()" (refresh)="onRefreshData()">
  </app-unified-filter>

  <!-- View Mode Toggle -->
  <div class="d-flex justify-content-between align-items-center mb-3">
    <div class="btn-group" role="group">
      <input type="radio" class="btn-check" name="viewMode" id="tableMode" [checked]="viewMode() === 'table'"
      ...
      <input type="radio" class="btn-check" name="viewMode" id="treeMode" [checked]="viewMode() === 'tree'"
  ...
  <div class="alert alert-info">
    <div class="d-flex align-items-center">
      ...
      <div>
        ...
        <small>{{ i18n.t('department.showingAllDepartments') || 'Showing departments from all branches. Select a
          specific branch to filter.' }}</small>
      </div>
    </div>
  </div>
  }
  ...
  <!-- Table View -->
  @if (viewMode() === 'table') {
  <app-department-table [selectedBranchId]="selectedBranch()?.id" [allowSelection]="true" [allowEdit]="true"
    [allowDelete]="true" [showControls]="true" (departmentSelected)="onDepartmentSelected($event)"
    (departmentView)="onDepartmentView($event)" (departmentEdit)="onDepartmentEdit($event)"
    (departmentDelete)="onDepartmentDelete($event)" (departmentAdd)="onDepartmentAdd()"></app-department-table>
  }

  <!-- Tree View -->
  @if (viewMode() === 'tree') {
  <app-department-tree [selectedBranchId]="selectedBranch()?.id" [allowSelection]="true" [allowEdit]="true"
    [allowDelete]="true" [showControls]="true" (departmentSelected)="onDepartmentSelected($event)"
    (departmentView)="onDepartmentView($event)" (departmentEdit)="onDepartmentEdit($event)"
    (departmentDelete)="onDepartmentDelete($event)" (departmentAdd)="onDepartmentAdd($event)"></app-department-tree>
  }


  <!-- Department Info Panel Component -->
  <app-department-info-panel [selectedDepartment]="selectedDepartment()" (departmentView)="onDepartmentView($event)"
    (departmentEdit)="onDepartmentEdit($event)" (departmentDelete)="onDepartmentDelete($event)"
    (closePanel)="onCloseInfoPanel()"></app-department-info-panel>
...
//# sourceMappingURL=chunk-XIJ23SSJ.js.map

...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Conditional_34_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", period_r3.startTime, " - ", period_r3.endTime);
  }
}
__name(DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Conditional_34_For_6_Template, "DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Conditional_34_For_6_Template");
function DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "div", 23)(2, "strong");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ul", 55);
    \u0275\u0275repeaterCreate(5, DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Conditional_34_For_6_Template, 2, 2, "li", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const shiftData_r4 = \u0275\u0275nextContext();
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("shifts.fields.periods"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(shiftData_r4.periods);
  }
}
__name(DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Conditional_34_Template, "DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Conditional_34_Template");
function DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(27, "div", 47)(28, "div", 23)(29, "strong");
    \u0275\u0275text(30);
    \u0275\u0275elementEnd();
    \u0275\u0275element(31, "br");
    ...
    \u0275\u0275text(33);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(34, DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Conditional_34_Template, 7, 1, "div", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const shiftData_r4 = ctx;
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("shifts.fields.name"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(shiftData_r4.name);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("shifts.fields.shift_type"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.getShiftTypeDisplay(shiftData_r4));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("shifts.fields.start_time"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.getShiftStartTime(shiftData_r4));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("shifts.fields.end_time"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.getShiftEndTime(shiftData_r4));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("shifts.fields.working_hours"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.formatHoursAsTime(shiftData_r4.totalHours || 0));
    \u0275\u0275advance();
    \u0275\u0275conditional(shiftData_r4.periods && shiftData_r4.periods.length > 1 ? 34 : -1);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_8_For_5_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 63)(1, "div", 23)(2, "strong");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const vacation_r5 = \u0275\u0275nextContext().$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_vacations.fields.notes"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(vacation_r5.notes);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_8_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61)(1, "div", 28)(2, "div", 29)(3, "div", 30)(4, "strong");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "br");
    ...
    \u0275\u0275text(23);
    \u0275\u0275elementEnd();
    \u0275\u0275element(24, "br")(25, "app-status-badge", 62);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(32, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_8_For_5_Conditional_32_Template, 6, 2, "div", 63);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(vacation_r5.vacationTypeName);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_vacations.fields.period"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", ctx_r0.formatDate(vacation_r5.startDate), " - ", ctx_r0.formatDate(vacation_r5.endDate), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_vacations.fields.duration"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("", vacation_r5.durationDays, " ", vacation_r5.durationDays === 1 ? ctx_r0.i18n.t("common.dayUnit") : ctx_r0.i18n.t("common.days_text"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_vacations.fields.status"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275property("label", vacation_r5.statusDisplay)("variant", ctx_r0.getVacationStatusVariant(vacation_r5.status))("icon", ctx_r0.getVacationStatusIcon(vacation_r5.status));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("common.created_date"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.formatDate(vacation_r5.createdAtUtc));
    \u0275\u0275advance();
    \u0275\u0275conditional(vacation_r5.notes ? 32 : -1);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_8_For_5_Template, 33, 15, "div", 61, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275element(2, "br")(3, "app-status-badge", 62);
  }
  if (rf & 2) {
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Conditional_35_Conditional_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const excuse_r6 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.formatDate(excuse_r6.approvedAt));
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Conditional_35_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const excuse_r6 = \u0275\u0275nextContext().$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_excuses.fields.approved_by"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(excuse_r6.approvedByName);
    \u0275\u0275advance();
    \u0275\u0275conditional(excuse_r6.approvedAt ? 6 : -1);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Conditional_36_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(excuse_r6.rejectionReason);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Conditional_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(excuse_r6.processingNotes);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 66)(1, "div", 28)(2, "div", 29)(3, "div", 30)(4, "strong");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "br");
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(29, "div", 63)(30, "div", 67)(31, "strong");
    \u0275\u0275text(32);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "p", 64);
    \u0275\u0275text(34);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(35, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Conditional_35_Template, 7, 3, "div", 67);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(36, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Conditional_36_Template, 6, 2, "div", 63);
    \u0275\u0275conditionalCreate(37, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Conditional_37_Template, 6, 2, "div", 63);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const excuse_r6 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_excuses.fields.excuse_type"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(excuse_r6.excuseTypeDisplay);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_excuses.fields.time_period"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(excuse_r6.timeRangeDisplay);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_excuses.fields.duration"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(excuse_r6.durationDisplay);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_excuses.fields.status"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275classMap(ctx_r0.getApprovalStatusBadgeClass(excuse_r6.approvalStatusDisplay));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", excuse_r6.approvalStatusDisplay, " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(excuse_r6.hasAttachment ? 28 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("employee_excuses.fields.reason"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(excuse_r6.reason);
    \u0275\u0275advance();
    \u0275\u0275conditional(excuse_r6.approvedByName ? 35 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(excuse_r6.rejectionReason ? 36 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(excuse_r6.processingNotes ? 37 : -1);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "h6", 65);
    \u0275\u0275element(2, "i", 46);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_For_5_Template, 38, 16, "div", 66, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_10_For_5_Conditional_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const remoteWork_r7 = \u0275\u0275nextContext().$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("attendance.remote_work.time_period"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("", remoteWork_r7.startTime, " - ", remoteWork_r7.endTime);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_10_For_5_Conditional_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(remoteWork_r7.notes);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_10_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 71)(1, "div", 28)(2, "div", 29)(3, "div", 30)(4, "strong");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "br");
    ...
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275element(20, "br")(21, "app-status-badge", 62);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(22, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_10_For_5_Conditional_22_Template, 6, 2, "div", 63);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const remoteWork_r7 = ctx.$implicit;
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("attendance.remote_work.work_type"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(remoteWork_r7.workType);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("attendance.remote_work.location"), ":");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(remoteWork_r7.workLocation);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(remoteWork_r7.startTime && remoteWork_r7.endTime ? 16 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx_r0.i18n.t("attendance.remote_work.status"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275property("label", remoteWork_r7.isApproved ? ctx_r0.i18n.t("attendance.remote_work.approved") : ctx_r0.i18n.t("attendance.remote_work.pending"))("variant", remoteWork_r7.isApproved ? "success" : "warning")("icon", remoteWork_r7.isApproved ? "fas fa-check-circle" : "fas fa-hourglass-half");
    \u0275\u0275advance();
    \u0275\u0275conditional(remoteWork_r7.notes ? 22 : -1);
  }
}
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 58)(1, "h6", 69);
    \u0275\u0275element(2, "i", 70);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_10_For_5_Template, 23, 10, "div", 71, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(8, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_8_Template, 6, 1, "div", 58);
    \u0275\u0275conditionalCreate(9, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_9_Template, 6, 1, "div", 58);
    \u0275\u0275conditionalCreate(10, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Conditional_10_Template, 6, 1, "div", 58);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_3_0;
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_133_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "br")(4, "app-status-badge", 62);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function DailyAttendanceDetailComponent_Conditional_2_Conditional_133_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(9, DailyAttendanceDetailComponent_Conditional_2_Conditional_133_Conditional_9_Template, 6, 2, "div", 67);
    \u0275\u0275conditionalCreate(10, DailyAttendanceDetailComponent_Conditional_2_Conditional_133_Conditional_10_Template, 5, 4, "div", 67);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function DailyAttendanceDetailComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(130, DailyAttendanceDetailComponent_Conditional_2_Conditional_130_Template, 35, 11, "div")(131, DailyAttendanceDetailComponent_Conditional_2_Conditional_131_Template, 4, 1, "div", 50);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(132, DailyAttendanceDetailComponent_Conditional_2_Conditional_132_Template, 11, 4, "div", 22);
    \u0275\u0275conditionalCreate(133, DailyAttendanceDetailComponent_Conditional_2_Conditional_133_Template, 11, 3, "div", 29);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_10_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.attendanceRecord().notes || ctx_r0.attendanceRecord().isManualOverride ? 133 : -1);
  }
}
...
var _DailyAttendanceDetailComponent = class _DailyAttendanceDetailComponent {
  ...
  getVacationStatusVariant(status) {
    switch (status?.toLowerCase()) {
      case "approved":
        return "success";
      case "completed":
              ...
              <div>\r
                ...
                <div class="row mb-3">\r
                  <div class="col-12">\r
                    ...
                    <br>\r
                    <span class="text-primary fw-bold">{{ formatHoursAsTime(shiftData.totalHours || 0) }}</span>\r
                  </div>\r
                </div>\r
                @if (shiftData.periods && shiftData.periods.length > 1) {\r
                  <div class="row">\r
                    <div class="col-12">\r
                      <strong>{{ i18n.t('shifts.fields.periods') }}:</strong>\r
                      <ul class="mb-0 mt-2">\r
                        @for (period of shiftData.periods; track $index) {\r
                          <li>{{ period.startTime }} - {{ period.endTime }}</li>\r
                        }\r
                      </ul>\r
                    </div>\r
                  </div>\r
                      ...
                      <div class="card-body">\r
                        <div class="row">\r
                          ...
                          <div class="col-md-2">\r
                            ...
                            <br>\r
                            <app-status-badge\r
                              [label]="vacation.statusDisplay"\r
                              [variant]="getVacationStatusVariant(vacation.status)"\r
                              [icon]="getVacationStatusIcon(vacation.status)">\r
                            </app-status-badge>\r
                          </div>\r
                          <div class="col-md-2">\r
...
\r
    <!-- Additional Information (Notes and Manual Override only) -->\r
    @if (attendanceRecord()!.notes || attendanceRecord()!.isManualOverride) {\r
      <div class="row">\r
        <div class="col-12">\r
          <div class="card">\r
            <div class="card-header">\r
...
//# sourceMappingURL=chunk-EIFJBDBE.js.map

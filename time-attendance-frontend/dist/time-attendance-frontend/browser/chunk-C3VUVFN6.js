...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DepartmentFormComponent, [{
    type: Component,
    args: [{ selector: "app-department-form", standalone: true, imports: [ReactiveFormsModule, SearchableSelectComponent, FormSectionComponent, LoadingSpinnerComponent], template: `<form [formGroup]="form" (ngSubmit)="onSubmit()">
...
//# sourceMappingURL=chunk-C3VUVFN6.js.map

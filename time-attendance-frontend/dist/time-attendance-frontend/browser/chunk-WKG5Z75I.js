...
function CreateShiftComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "label", 62);
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "span", 12);
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 50)(6, "input", 63);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_40_Template_input_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.shiftForm.requiredHours, $event) || (ctx_r2.shiftForm.requiredHours = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_40_Template_input_ngModelChange_6_listener"));
    \u0275\u0275elementEnd();
...
__name(CreateShiftComponent_Conditional_40_Template, "CreateShiftComponent_Conditional_40_Template");
function CreateShiftComponent_Conditional_89_Template(rf, ctx) {
  if (rf & 1) {
...
__name(CreateShiftComponent_Conditional_89_Template, "CreateShiftComponent_Conditional_89_Template");
function CreateShiftComponent_Conditional_90_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 69);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_90_Conditional_4_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.addShiftPeriod());
    }, "CreateShiftComponent_Conditional_90_Conditional_4_Template_button_click_0_listener"));
    \u0275\u0275element(1, "i", 70);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  }
...
__name(CreateShiftComponent_Conditional_90_Conditional_4_Template, "CreateShiftComponent_Conditional_90_Conditional_4_Template");
function CreateShiftComponent_Conditional_90_For_6_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 79);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_90_For_6_Conditional_9_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const $index_r7 = \u0275\u0275nextContext().$index;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeShiftPeriod($index_r7));
    }, "CreateShiftComponent_Conditional_90_For_6_Conditional_9_Template_button_click_0_listener"));
    \u0275\u0275element(1, "i", 80);
    \u0275\u0275elementEnd();
  }
}
__name(CreateShiftComponent_Conditional_90_For_6_Conditional_9_Template, "CreateShiftComponent_Conditional_90_For_6_Conditional_9_Template");
function CreateShiftComponent_Conditional_90_For_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 66)(1, "div", 71)(2, "span", 21);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, CreateShiftComponent_Conditional_90_For_6_Conditional_9_Template, 2, 0, "button", 75);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 76)(11, "div", 2)(12, "div", 17)(13, "label", 77);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "input", 78);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_90_For_6_Template_input_ngModelChange_15_listener($event) {
      const period_r8 = \u0275\u0275restoreView(_r5).$implicit;
      \u0275\u0275twoWayBindingSet(period_r8.startTime, $event) || (period_r8.startTime = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_90_For_6_Template_input_ngModelChange_15_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 17)(17, "label", 77);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "input", 78);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_90_For_6_Template_input_ngModelChange_19_listener($event) {
      const period_r8 = \u0275\u0275restoreView(_r5).$implicit;
      \u0275\u0275twoWayBindingSet(period_r8.endTime, $event) || (period_r8.endTime = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_90_For_6_Template_input_ngModelChange_19_listener"));
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
__name(CreateShiftComponent_Conditional_90_For_6_Template, "CreateShiftComponent_Conditional_90_For_6_Template");
function CreateShiftComponent_Conditional_90_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "app-form-section", 8)(1, "div", 9)(2, "div", 3)(3, "div", 64);
    \u0275\u0275conditionalCreate(4, CreateShiftComponent_Conditional_90_Conditional_4_Template, 3, 1, "button", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(5, CreateShiftComponent_Conditional_90_For_6_Template, 20, 12, "div", 66, \u0275\u0275repeaterTrackByIndex);
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("title", ctx_r2.t("shifts.periods"));
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r2.shiftForm.shiftPeriods.length < 2 ? 4 : -1);
    \u0275\u0275advance();
...
__name(CreateShiftComponent_Conditional_90_Template, "CreateShiftComponent_Conditional_90_Template");
function CreateShiftComponent_Conditional_100_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "label", 81);
    \u0275\u0275text(2);
    \u0275\u0275elementStart(3, "span", 12);
    \u0275\u0275text(4, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "input", 82);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_100_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.shiftForm.coreStart, $event) || (ctx_r2.shiftForm.coreStart = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_100_Template_input_ngModelChange_5_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 10)(7, "label", 83);
    \u0275\u0275text(8);
    \u0275\u0275elementStart(9, "span", 12);
    \u0275\u0275text(10, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "input", 84);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_100_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.shiftForm.coreEnd, $event) || (ctx_r2.shiftForm.coreEnd = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_100_Template_input_ngModelChange_11_listener"));
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
__name(CreateShiftComponent_Conditional_100_Template, "CreateShiftComponent_Conditional_100_Template");
...
function CreateShiftComponent_Conditional_127_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 44);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
__name(CreateShiftComponent_Conditional_127_Conditional_9_Template, "CreateShiftComponent_Conditional_127_Conditional_9_Template");
function CreateShiftComponent_Conditional_127_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "label", 89);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 50)(4, "input", 90);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_127_Conditional_17_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.shiftForm.flexMinutesBefore, $event) || (ctx_r2.shiftForm.flexMinutesBefore = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_127_Conditional_17_Template_input_ngModelChange_4_listener"));
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 10)(10, "label", 91);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 50)(13, "input", 92);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_127_Conditional_17_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.shiftForm.flexMinutesAfter, $event) || (ctx_r2.shiftForm.flexMinutesAfter = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_127_Conditional_17_Template_input_ngModelChange_13_listener"));
    \u0275\u0275elementEnd();
...
__name(CreateShiftComponent_Conditional_127_Conditional_17_Template, "CreateShiftComponent_Conditional_127_Conditional_17_Template");
function CreateShiftComponent_Conditional_127_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "label", 85);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 50)(4, "input", 86);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_127_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.shiftForm.gracePeriodMinutes, $event) || (ctx_r2.shiftForm.gracePeriodMinutes = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_127_Template_input_ngModelChange_4_listener"));
    \u0275\u0275listener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_127_Template_input_ngModelChange_4_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, CreateShiftComponent_Conditional_127_Conditional_9_Template, 2, 1, "small", 44);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 14)(11, "div", 45)(12, "input", 87);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_127_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.shiftForm.allowFlexibleHours, $event) || (ctx_r2.shiftForm.allowFlexibleHours = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Conditional_127_Template_input_ngModelChange_12_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function CreateShiftComponent_Conditional_127_Template_input_change_12_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onFlexibleHoursChange());
    }, "CreateShiftComponent_Conditional_127_Template_input_change_12_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "label", 88);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 48);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(17, CreateShiftComponent_Conditional_127_Conditional_17_Template, 18, 8);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
...
function CreateShiftComponent_Conditional_128_For_9_Template(rf, ctx) {
  if (rf & 1) {
...
__name(CreateShiftComponent_Conditional_128_For_9_Template, "CreateShiftComponent_Conditional_128_For_9_Template");
function CreateShiftComponent_Conditional_128_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "div", 3)(2, "div", 93)(3, "div", 94);
    \u0275\u0275element(4, "i", 95);
    \u0275\u0275elementStart(5, "div")(6, "h6", 96);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(8, CreateShiftComponent_Conditional_128_For_9_Template, 2, 1, "div", 97, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
__name(CreateShiftComponent_Conditional_128_Template, "CreateShiftComponent_Conditional_128_Template");
function CreateShiftComponent_Conditional_136_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 98);
    \u0275\u0275text(1);
  }
...
__name(CreateShiftComponent_Conditional_136_Template, "CreateShiftComponent_Conditional_136_Template");
function CreateShiftComponent_Conditional_137_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 99);
    \u0275\u0275text(1);
  }
...
__name(CreateShiftComponent_Conditional_137_Template, "CreateShiftComponent_Conditional_137_Template");
...
__publicField(_CreateShiftComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CreateShiftComponent, selectors: [["app-create-shift"]], decls: 138, vars: 66, consts: [["formRef", "ngForm"], [1, "container-fluid", "px-4"], [1, "row"], [1, "col-12"], ["mode", "create", "moduleName", "shifts", "moduleRoute", "shifts", 3, "title", "subtitle"], [1, "card", "border-0", "shadow-sm"], [1, "card-body", "p-4"], [3, "ngSubmit"], [3, "title"], [1, "row", "mb-4"], [1, "col-md-6", "mb-3"], ["for", "name", 1, "form-label"], [1, "text-danger"], ["type", "text", "id", "name", "name", "name", "required", "", "maxlength", "200", 1, "form-control", 3, "ngModelChange", "ngModel", "placeholder"], [1, "col-12", "mb-3"], ["for", "description", 1, "form-label"], ["id", "description", "name", "description", "rows", "3", "maxlength", "1000", 1, "form-control", 3, "ngModelChange", "ngModel", "placeholder"], [1, "col-md-6"], [1, "form-check", "p-3", "border", "rounded"], ["type", "radio", "name", "shiftType", "id", "timeBased", 1, "form-check-input", 3, "ngModelChange", "change", "value", "ngModel"], ["for", "timeBased", 1, "form-check-label", "w-100"], [1, "fw-medium"], [1, "text-muted"], ["type", "radio", "name", "shiftType", "id", "hoursOnly", 1, "form-check-input", 3, "ngModelChange", "change", "value", "ngModel"], ["for", "hoursOnly", 1, "form-check-label", "w-100"], [1, "col-md-3", "col-6", "mb-2"], [1, "form-check"], ["type", "checkbox", "id", "sunday", "name", "isSunday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "sunday", 1, "form-check-label"], ["type", "checkbox", "id", "monday", "name", "isMonday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "monday", 1, "form-check-label"], ["type", "checkbox", "id", "tuesday", "name", "isTuesday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "tuesday", 1, "form-check-label"], ["type", "checkbox", "id", "wednesday", "name", "isWednesday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "wednesday", 1, "form-check-label"], ["type", "checkbox", "id", "thursday", "name", "isThursday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "thursday", 1, "form-check-label"], ["type", "checkbox", "id", "friday", "name", "isFriday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "friday", 1, "form-check-label"], ["type", "checkbox", "id", "saturday", "name", "isSaturday", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "saturday", 1, "form-check-label"], [1, "col-12", "mt-3"], ["type", "checkbox", "id", "nightShift", "name", "isNightShift", 1, "form-check-input", 3, "ngModelChange", "change", "ngModel", "disabled"], ["for", "nightShift", 1, "form-check-label", "fw-medium"], [1, "text-warning", "d-block"], [1, "form-check", "form-switch"], ["type", "checkbox", "id", "hasCoreHours", "name", "hasCoreHours", 1, "form-check-input", 3, "ngModelChange", "change", "ngModel"], ["for", "hasCoreHours", 1, "form-check-label"], [1, "form-text"], ["for", "requiredWeeklyHours", 1, "form-label"], [1, "input-group"], ["type", "number", "id", "requiredWeeklyHours", "name", "requiredWeeklyHours", "step", "0.5", "min", "0", "max", "168", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "input-group-text"], [1, "text-info", "d-block"], ["type", "checkbox", "id", "checkInRequired", "name", "isCheckInRequired", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "checkInRequired", 1, "form-check-label"], ["type", "checkbox", "id", "autoCheckOut", "name", "isAutoCheckOut", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "autoCheckOut", 1, "form-check-label"], [1, "mb-4"], [1, "d-flex", "justify-content-end", "gap-2"], ["type", "button", 1, "btn", "btn-outline-secondary", 3, "click", "disabled"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["for", "requiredHours", 1, "form-label"], ["type", "number", "id", "requiredHours", "name", "requiredHours", "step", "0.5", "min", "0.5", "max", "24", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "d-flex", "justify-content-end", "mb-3"], ["type", "button", 1, "btn", "btn-outline-primary", "btn-sm"], [1, "card", "border", "mb-3"], [1, "alert", "alert-info", "d-flex", "align-items-center"], [1, "bi", "bi-info-circle", "me-2"], ["type", "button", 1, "btn", "btn-outline-primary", "btn-sm", 3, "click"], [1, "bi", "bi-plus-circle", "me-1"], [1, "card-header", "bg-light", "d-flex", "justify-content-between", "align-items-center", "py-2"], [1, "d-flex", "align-items-center", "gap-2"], [1, "badge", 3, "ngClass"], [1, "text-muted", "small"], ["type", "button", 1, "btn", "btn-outline-danger", "btn-sm"], [1, "card-body"], [1, "form-label"], ["type", "time", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel", "name"], ["type", "button", 1, "btn", "btn-outline-danger", "btn-sm", 3, "click"], [1, "bi", "bi-trash"], ["for", "coreStart", 1, "form-label"], ["type", "time", "id", "coreStart", "name", "coreStart", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "coreEnd", 1, "form-label"], ["type", "time", "id", "coreEnd", "name", "coreEnd", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "gracePeriod", 1, "form-label"], ["type", "number", "id", "gracePeriod", "name", "gracePeriodMinutes", "min", "0", "max", "120", 1, "form-control", 3, "ngModelChange", "ngModel", "disabled"], ["type", "checkbox", "id", "flexibleHours", "name", "allowFlexibleHours", 1, "form-check-input", 3, "ngModelChange", "change", "ngModel"], ["for", "flexibleHours", 1, "form-check-label"], ["for", "flexBefore", 1, "form-label"], ["type", "number", "id", "flexBefore", "name", "flexMinutesBefore", "min", "1", "max", "480", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "flexAfter", 1, "form-label"], ["type", "number", "id", "flexAfter", "name", "flexMinutesAfter", "min", "1", "max", "480", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "alert", "alert-danger"], [1, "d-flex", "align-items-start"], [1, "bi", "bi-exclamation-triangle", "me-2", "mt-1"], [1, "alert-heading", "mb-2"], [1, "mb-1"], ["role", "status", "aria-hidden", "true", 1, "spinner-border", "spinner-border-sm", "me-2"], [1, "bi", "bi-check-circle", "me-2"]], template: /* @__PURE__ */ __name(function CreateShiftComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(8, "app-form-section", 8)(9, "div", 9)(10, "div", 10)(11, "label", 11);
    \u0275\u0275text(12);
    \u0275\u0275elementStart(13, "span", 12);
    \u0275\u0275text(14, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "input", 13);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.name, $event) || (ctx.shiftForm.name = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_15_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "div", 14)(17, "label", 15);
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "textarea", 16);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_textarea_ngModelChange_19_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.description, $event) || (ctx.shiftForm.description = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_textarea_ngModelChange_19_listener"));
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(20, "app-form-section", 8)(21, "div", 9)(22, "div", 14)(23, "div", 2)(24, "div", 17)(25, "div", 18)(26, "input", 19);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_26_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.shiftType, $event) || (ctx.shiftForm.shiftType = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_26_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_change_26_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onShiftTypeChange());
    }, "CreateShiftComponent_Template_input_change_26_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "label", 20)(28, "div", 21);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "small", 22);
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(32, "div", 17)(33, "div", 18)(34, "input", 23);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_34_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.shiftType, $event) || (ctx.shiftForm.shiftType = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_34_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_change_34_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onShiftTypeChange());
    }, "CreateShiftComponent_Template_input_change_34_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "label", 24)(36, "div", 21);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "small", 22);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275conditionalCreate(40, CreateShiftComponent_Conditional_40_Template, 11, 4, "div", 10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "app-form-section", 8)(42, "div", 9)(43, "div", 14)(44, "div", 2)(45, "div", 25)(46, "div", 26)(47, "input", 27);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_47_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isSunday, $event) || (ctx.shiftForm.isSunday = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_47_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "label", 28);
    \u0275\u0275text(49);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(50, "div", 25)(51, "div", 26)(52, "input", 29);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_52_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isMonday, $event) || (ctx.shiftForm.isMonday = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_52_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "label", 30);
    \u0275\u0275text(54);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(55, "div", 25)(56, "div", 26)(57, "input", 31);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_57_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isTuesday, $event) || (ctx.shiftForm.isTuesday = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_57_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "label", 32);
    \u0275\u0275text(59);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(60, "div", 25)(61, "div", 26)(62, "input", 33);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_62_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isWednesday, $event) || (ctx.shiftForm.isWednesday = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_62_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "label", 34);
    \u0275\u0275text(64);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(65, "div", 25)(66, "div", 26)(67, "input", 35);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_67_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isThursday, $event) || (ctx.shiftForm.isThursday = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_67_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "label", 36);
    \u0275\u0275text(69);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(70, "div", 25)(71, "div", 26)(72, "input", 37);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_72_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isFriday, $event) || (ctx.shiftForm.isFriday = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_72_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "label", 38);
    \u0275\u0275text(74);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(75, "div", 25)(76, "div", 26)(77, "input", 39);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_77_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isSaturday, $event) || (ctx.shiftForm.isSaturday = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_77_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "label", 40);
    \u0275\u0275text(79);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(80, "small", 22);
    \u0275\u0275text(81);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(82, "div", 41)(83, "div", 26)(84, "input", 42);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_84_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isNightShift, $event) || (ctx.shiftForm.isNightShift = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_84_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_change_84_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onNightShiftChange());
    }, "CreateShiftComponent_Template_input_change_84_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "label", 43);
    \u0275\u0275text(86);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(87, "small", 22);
    \u0275\u0275text(88);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(89, CreateShiftComponent_Conditional_89_Template, 2, 1, "small", 44);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(90, CreateShiftComponent_Conditional_90_Template, 13, 4, "app-form-section", 8);
    \u0275\u0275elementStart(91, "app-form-section", 8)(92, "div", 9)(93, "div", 14)(94, "div", 45)(95, "input", 46);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_95_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.hasCoreHours, $event) || (ctx.shiftForm.hasCoreHours = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_95_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_change_95_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onCoreHoursChange());
    }, "CreateShiftComponent_Template_input_change_95_listener"));
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(99);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(100, CreateShiftComponent_Conditional_100_Template, 12, 4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(101, "app-form-section", 8)(102, "div", 9)(103, "div", 10)(104, "label", 49);
    \u0275\u0275text(105);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(106, "div", 50)(107, "input", 51);
    ...
    \u0275\u0275listener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_107_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(109);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(110, "div", 48);
    \u0275\u0275text(111);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(112, CreateShiftComponent_Conditional_112_Template, 2, 1, "small", 53);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(113, "div", 10)(114, "div", 45)(115, "input", 54);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function CreateShiftComponent_Template_input_ngModelChange_115_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isCheckInRequired, $event) || (ctx.shiftForm.isCheckInRequired = $event);
      return \u0275\u0275resetView($event);
    }, "CreateShiftComponent_Template_input_ngModelChange_115_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(116, "label", 55);
    \u0275\u0275text(117);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(118, "div", 48);
    \u0275\u0275text(119);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(120, "div", 10)(121, "div", 45)(122, "input", 56);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(123, "label", 57);
    \u0275\u0275text(124);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(125, "div", 48);
    \u0275\u0275text(126);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(127, CreateShiftComponent_Conditional_127_Template, 18, 10);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(128, CreateShiftComponent_Conditional_128_Template, 10, 1, "div", 9);
    \u0275\u0275elementStart(129, "div", 2)(130, "div", 3);
    \u0275\u0275element(131, "hr", 58);
    \u0275\u0275elementStart(132, "div", 59)(133, "button", 60);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function CreateShiftComponent_Template_button_click_133_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onCancel());
    }, "CreateShiftComponent_Template_button_click_133_listener"));
    \u0275\u0275text(134);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(135, "button", 61);
    \u0275\u0275conditionalCreate(136, CreateShiftComponent_Conditional_136_Template, 2, 1)(137, CreateShiftComponent_Conditional_137_Template, 2, 1);
    \u0275\u0275elementEnd()()()()()()()()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("title", ctx.t("common.basicInformation"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx.t("shifts.type"));
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.shiftForm.shiftType === ctx.ShiftType.HoursOnly ? 40 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx.t("shifts.workingDays"));
    \u0275\u0275advance(6);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.shiftForm.shiftType === ctx.ShiftType.HoursOnly ? 89 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.shiftForm.shiftType === ctx.ShiftType.TimeBased ? 90 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx.t("shifts.coreHours"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.shiftForm.hasCoreHours ? 100 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx.t("shifts.advancedOptions"));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.shiftForm.requiredWeeklyHours && ctx.shiftForm.requiredWeeklyHours > 0 ? 112 : -1);
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.shiftForm.shiftType === ctx.ShiftType.TimeBased ? 127 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx.isFormValid() && ctx.shiftForm.name ? 128 : -1);
    \u0275\u0275advance(5);
                ...
                <div class="col-12 mt-3">\r
                  <div class="form-check">\r
                    <input\r
                      ...
                      name="isNightShift"\r
                      (change)="onNightShiftChange()"\r
                      [disabled]="shiftForm.shiftType === ShiftType.HoursOnly">\r
                  ...
                  @if (shiftForm.shiftType === ShiftType.HoursOnly) {\r
                    <small class="text-warning d-block">{{ t('shifts.help.nightShiftDisabledHoursOnly') }}</small>\r
                  }\r
                </div>\r
              </div>\r
            </app-form-section>\r
                ...
                <div class="col-md-6 mb-3">\r
                  ...
                  <div class="input-group">\r
                    <input\r
                      ...
                      (ngModelChange)="onWeeklyHoursChange()"\r
                      step="0.5"\r
                      min="0"\r
                      max="168">\r
                    <span class="input-group-text">{{ t('shifts.hours') }}</span>\r
                  ...
                  @if (shiftForm.requiredWeeklyHours && shiftForm.requiredWeeklyHours > 0) {\r
                    <small class="text-info d-block">{{ t('shifts.help.weeklyHoursCoreRequired') }}</small>\r
                  }\r
                </div>\r
\r
                <!-- Check-in Required -->\r
                  ...
                  <div class="col-md-6 mb-3">\r
                    ...
                    <div class="input-group">\r
                      <input\r
                        ...
                        [disabled]="shiftForm.allowFlexibleHours"\r
                        min="0"\r
                        max="120">\r
                    ...
                    @if (shiftForm.allowFlexibleHours) {\r
                      <small class="text-warning d-block">{{ t('shifts.help.gracePeriodDisabledFlexible') }}</small>\r
                    }\r
                  </div>\r
\r
                  <!-- Flexible Hours -->\r
                ...
                <div class="d-flex justify-content-end gap-2">\r
                  ...
                  <button\r
                    ...
                    @if (submitting()) {\r
                      ...
                      {{ t('shifts.loading.creating') }}\r
                    } @else {\r
                      <i class="bi bi-check-circle me-2"></i>{{ t('shifts.create') }}\r
                    }\r
                  </button>\r
                </div>\r
              </div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreateShiftComponent, { className: "CreateShiftComponent", filePath: "src/app/pages/shifts/create-shift/create-shift.component.ts", lineNumber: 22 });
})();
export {
  CreateShiftComponent
};
//# sourceMappingURL=chunk-WKG5Z75I.js.map

...
(() => {
  ...
  <!-- Page Header -->\r
  <app-page-header\r
    [title]="t('excuse_policies.title')">\r
  </app-page-header>\r
\r
...
\r
  ...
  <app-data-table\r
    ...
    [loading]="loading"\r
    [emptyTitle]="t('excuse_policies.no_policies_found')"\r
    [emptyMessage]="hasActiveFilters() ? t('common.try_different_filters') : t('excuse_policies.subtitle')"\r
...
//# sourceMappingURL=chunk-TMPZRULI.js.map

...
function BranchTableComponent_ng_template_1_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
__name(BranchTableComponent_ng_template_1_div_1_Template, "BranchTableComponent_ng_template_1_div_1_Template");
function BranchTableComponent_ng_template_1_div_2_Template(rf, ctx) {
  if (rf & 1) {
...
__name(BranchTableComponent_ng_template_1_div_2_Template, "BranchTableComponent_ng_template_1_div_2_Template");
function BranchTableComponent_ng_template_1_span_3_Template(rf, ctx) {
  if (rf & 1) {
...
__name(BranchTableComponent_ng_template_1_span_3_Template, "BranchTableComponent_ng_template_1_span_3_Template");
function BranchTableComponent_ng_template_1_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
__name(BranchTableComponent_ng_template_1_span_4_Template, "BranchTableComponent_ng_template_1_span_4_Template");
function BranchTableComponent_ng_template_1_span_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.formatDate(branch_r2.createdAt), " ");
  }
}
__name(BranchTableComponent_ng_template_1_span_5_Template, "BranchTableComponent_ng_template_1_span_5_Template");
function BranchTableComponent_ng_template_1_span_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.formatDate(branch_r2.updatedAt), " ");
  }
}
__name(BranchTableComponent_ng_template_1_span_6_Template, "BranchTableComponent_ng_template_1_span_6_Template");
function BranchTableComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0, 2);
    \u0275\u0275template(1, BranchTableComponent_ng_template_1_div_1_Template, 9, 3, "div", 3)(2, BranchTableComponent_ng_template_1_div_2_Template, 5, 2, "div", 4)(3, BranchTableComponent_ng_template_1_span_3_Template, 2, 3, "span", 4)(4, BranchTableComponent_ng_template_1_span_4_Template, 2, 2, "span", 4)(5, BranchTableComponent_ng_template_1_span_5_Template, 2, 1, "span", 4)(6, BranchTableComponent_ng_template_1_span_6_Template, 2, 1, "span", 4);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "branch");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "timezone");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "status");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "employeeCount");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "created");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "updated");
  }
}
...
__publicField(_BranchTableComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BranchTableComponent, selectors: [["app-branch-table"]], inputs: { branches: "branches", loading: "loading", currentPage: "currentPage", totalPages: "totalPages", totalItems: "totalItems", pageSize: "pageSize" }, outputs: { viewBranch: "viewBranch", editBranch: "editBranch", deleteBranch: "deleteBranch", pageChange: "pageChange", pageSizeChange: "pageSizeChange", selectionChange: "selectionChange", sortChange: "sortChange" }, decls: 3, vars: 9, consts: [["cellTemplate", ""], [3, "actionClick", "pageChange", "pageSizeChange", "selectionChange", "sortChange", "data", "columns", "actions", "loading", "currentPage", "totalPages", "totalItems", "pageSize", "emptyMessage"], [3, "ngSwitch"], ["class", "d-flex align-items-center", 4, "ngSwitchCase"], [4, "ngSwitchCase"], [1, "d-flex", "align-items-center"], [1, "avatar-sm", "me-2"], [1, "avatar-initial", "bg-info", "text-white", "rounded-circle"], [1, "fw-medium"], [1, "text-muted"], [3, "status", "label", "showIcon"], [3, "status", "label"]], template: /* @__PURE__ */ __name(function BranchTableComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, BranchTableComponent_ng_template_1_Template, 7, 7, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
}, "BranchTableComponent_Template"), dependencies: [CommonModule, NgSwitch, NgSwitchCase, DataTableComponent, StatusBadgeComponent], styles: ["\n\n.avatar-sm[_ngcontent-%COMP%] {\n  width: 2rem;\n  height: 2rem;\n}\n.avatar-initial[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  height: 100%;\n  font-size: 0.875rem;\n  font-weight: 600;\n}\n/*# sourceMappingURL=branch-table.component.css.map */"] }));
var BranchTableComponent = _BranchTableComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BranchTableComponent, [{
    type: Component,
    args: [{ selector: "app-branch-table", standalone: true, imports: [CommonModule, DataTableComponent, StatusBadgeComponent], template: `
    <app-data-table
      [data]="branches"
      [columns]="columns"
      [actions]="actions"
  ...
  `, styles: ["/* angular:styles/component:css;b01443c16e75437b73dd8a728713eee6579ca4d4c02199e6657f116651c97be5;D:/Work/AI Code/TimeAttendanceSystem/time-attendance-frontend/src/app/pages/branches/branch-table/branch-table.component.ts */\n.avatar-sm {\n  width: 2rem;\n  height: 2rem;\n}\n.avatar-initial {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  height: 100%;\n  font-size: 0.875rem;\n  font-weight: 600;\n}\n/*# sourceMappingURL=branch-table.component.css.map */\n"] }]
  }], null, { branches: [{
    type: Input
  }], loading: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BranchTableComponent, { className: "BranchTableComponent", filePath: "src/app/pages/branches/branch-table/branch-table.component.ts", lineNumber: 99 });
})();
...
function BranchFormModalComponent_div_6_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
__name(BranchFormModalComponent_div_6_div_1_Template, "BranchFormModalComponent_div_6_div_1_Template");
function BranchFormModalComponent_div_6_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
...
__name(BranchFormModalComponent_div_6_div_2_Template, "BranchFormModalComponent_div_6_div_2_Template");
function BranchFormModalComponent_div_6_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
...
__name(BranchFormModalComponent_div_6_div_3_Template, "BranchFormModalComponent_div_6_div_3_Template");
function BranchFormModalComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275template(1, BranchFormModalComponent_div_6_div_1_Template, 2, 0, "div", 21)(2, BranchFormModalComponent_div_6_div_2_Template, 2, 0, "div", 21)(3, BranchFormModalComponent_div_6_div_3_Template, 2, 0, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_1_0 = ctx_r0.branchForm.get("code")) == null ? null : tmp_1_0.errors == null ? null : tmp_1_0.errors["required"]);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_2_0 = ctx_r0.branchForm.get("code")) == null ? null : tmp_2_0.errors == null ? null : tmp_2_0.errors["minlength"]);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_3_0 = ctx_r0.branchForm.get("code")) == null ? null : tmp_3_0.errors == null ? null : tmp_3_0.errors["maxlength"]);
  }
}
__name(BranchFormModalComponent_div_6_Template, "BranchFormModalComponent_div_6_Template");
function BranchFormModalComponent_div_11_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
...
__name(BranchFormModalComponent_div_11_div_1_Template, "BranchFormModalComponent_div_11_div_1_Template");
function BranchFormModalComponent_div_11_div_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
...
__name(BranchFormModalComponent_div_11_div_2_Template, "BranchFormModalComponent_div_11_div_2_Template");
function BranchFormModalComponent_div_11_div_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
...
__name(BranchFormModalComponent_div_11_div_3_Template, "BranchFormModalComponent_div_11_div_3_Template");
function BranchFormModalComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275template(1, BranchFormModalComponent_div_11_div_1_Template, 2, 0, "div", 21)(2, BranchFormModalComponent_div_11_div_2_Template, 2, 0, "div", 21)(3, BranchFormModalComponent_div_11_div_3_Template, 2, 0, "div", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_1_0 = ctx_r0.branchForm.get("name")) == null ? null : tmp_1_0.errors == null ? null : tmp_1_0.errors["required"]);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_2_0 = ctx_r0.branchForm.get("name")) == null ? null : tmp_2_0.errors == null ? null : tmp_2_0.errors["minlength"]);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (tmp_3_0 = ctx_r0.branchForm.get("name")) == null ? null : tmp_3_0.errors == null ? null : tmp_3_0.errors["maxlength"]);
  }
}
__name(BranchFormModalComponent_div_11_Template, "BranchFormModalComponent_div_11_Template");
function BranchFormModalComponent_div_16_Template(rf, ctx) {
  if (rf & 1) {
...
__name(BranchFormModalComponent_div_16_Template, "BranchFormModalComponent_div_16_Template");
function BranchFormModalComponent_span_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 23);
  }
}
__name(BranchFormModalComponent_span_28_Template, "BranchFormModalComponent_span_28_Template");
function BranchFormModalComponent_i_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 24);
  }
}
__name(BranchFormModalComponent_i_29_Template, "BranchFormModalComponent_i_29_Template");
...
__publicField(_BranchFormModalComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BranchFormModalComponent, selectors: [["app-branch-form-modal"]], inputs: { show: "show", branch: "branch" }, outputs: { close: "close", save: "save" }, features: [\u0275\u0275NgOnChangesFeature], decls: 31, vars: 22, consts: [[3, "close", "show", "title", "centered", "loading"], [3, "ngSubmit", "formGroup"], [1, "mb-3"], ["for", "code", 1, "form-label"], ["type", "text", "id", "code", "formControlName", "code", "placeholder", "Enter branch code", 1, "form-control"], ["class", "invalid-feedback", 4, "ngIf"], ["for", "name", 1, "form-label"], ["type", "text", "id", "name", "formControlName", "name", "placeholder", "Enter branch name", 1, "form-control"], ["for", "timeZone", 1, "form-label"], [3, "selectionChange", "options", "value", "placeholder", "searchable", "clearable"], ["class", "invalid-feedback d-block", 4, "ngIf"], [1, "form-check"], ["type", "checkbox", "id", "isActive", "formControlName", "isActive", 1, "form-check-input"], ["for", "isActive", 1, "form-check-label"], [1, "form-text"], ["modal-footer", "", 1, "d-flex", "gap-2", "justify-content-end"], ["type", "button", 1, "btn", "btn-secondary", 3, "click", "disabled"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "spinner-border spinner-border-sm me-2", 4, "ngIf"], ["class", "fas fa-save me-2", 4, "ngIf"], [1, "invalid-feedback"], [4, "ngIf"], [1, "invalid-feedback", "d-block"], [1, "spinner-border", "spinner-border-sm", "me-2"], [1, "fas", "fa-save", "me-2"]], template: /* @__PURE__ */ __name(function BranchFormModalComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "input", 4);
    \u0275\u0275template(6, BranchFormModalComponent_div_6_Template, 4, 3, "div", 5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div", 2)(8, "label", 6);
    \u0275\u0275text(9, "Branch Name *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(10, "input", 7);
    \u0275\u0275template(11, BranchFormModalComponent_div_11_Template, 4, 3, "div", 5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(16, BranchFormModalComponent_div_16_Template, 2, 0, "div", 10);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(28, BranchFormModalComponent_span_28_Template, 1, 0, "span", 18)(29, BranchFormModalComponent_i_29_Template, 1, 0, "i", 19);
    \u0275\u0275text(30);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ((tmp_6_0 = ctx.branchForm.get("code")) == null ? null : tmp_6_0.invalid) && ((tmp_6_0 = ctx.branchForm.get("code")) == null ? null : tmp_6_0.touched));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ((tmp_8_0 = ctx.branchForm.get("name")) == null ? null : tmp_8_0.invalid) && ((tmp_8_0 = ctx.branchForm.get("name")) == null ? null : tmp_8_0.touched));
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ((tmp_14_0 = ctx.branchForm.get("timeZone")) == null ? null : tmp_14_0.invalid) && ((tmp_14_0 = ctx.branchForm.get("timeZone")) == null ? null : tmp_14_0.touched));
    \u0275\u0275advance(9);
...
}, "BranchFormModalComponent_Template"), dependencies: [CommonModule, NgIf, FormsModule, \u0275NgNoValidate, DefaultValueAccessor, CheckboxControlValueAccessor, NgControlStatus, NgControlStatusGroup, ReactiveFormsModule, FormGroupDirective, FormControlName, SearchableSelectComponent, ModalWrapperComponent], encapsulation: 2 }));
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BranchFormModalComponent, { className: "BranchFormModalComponent", filePath: "src/app/pages/branches/branch-form-modal/branch-form-modal.component.ts", lineNumber: 105 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BranchesComponent, [{
    ...
    args: [{ selector: "app-branches", standalone: true, imports: [
      ...
      BranchFormModalComponent,
      PageHeaderComponent
    ], template: `<div class="app-list-page">
  <!-- Page Header -->
  <app-page-header
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BranchesComponent, { className: "BranchesComponent", filePath: "src/app/pages/branches/branches.component.ts", lineNumber: 29 });
})();
export {
  BranchesComponent
};
//# sourceMappingURL=chunk-VULYJ2I2.js.map

...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(RoleManagementComponent, [{
    type: Component,
    args: [{ selector: "app-role-management", standalone: true, imports: [HasPermissionDirective, ModalWrapperComponent], template: `<app-modal-wrapper
  [show]="show && !!user"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UsersComponent, [{
    type: Component,
    args: [{ selector: "app-users", standalone: true, imports: [RoleManagementComponent, UnifiedFilterComponent, UserTableComponent, PageHeaderComponent], template: `<div class="app-list-page">
  <!-- Page Header -->
  <app-page-header
...
//# sourceMappingURL=chunk-SWIY2QHO.js.map

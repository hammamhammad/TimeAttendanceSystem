...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ViewUserComponent, [{
    type: Component,
    args: [{ selector: "app-view-user", standalone: true, imports: [HasPermissionDirective, FormHeaderComponent, LoadingSpinnerComponent, StatusBadgeComponent, BadgeListComponent, DefinitionListComponent], template: `<div class="container-fluid">\r
  <!-- Header -->\r
  <app-form-header\r
    mode="view"\r
    [title]="t('users.view_details')"\r
    moduleName="users"\r
    moduleRoute="users"\r
    [entityId]="userId"\r
    [loading]="loading()">\r
          ...
          <div class="card-header">\r
            <h5 class="card-title mb-0">\r
              <div class="d-flex align-items-center">\r
                ...
                <div>\r
                  <div class="fw-medium">\r
                    {{ user()?.username }}\r
                    @if (user()?.mustChangePassword) {\r
                      <i class="fa-solid fa-exclamation-triangle text-warning ms-2" [title]="t('users.must_change_password')"></i>\r
                    }\r
                  </div>\r
                  <small class="text-muted">{{ user()?.email }}</small>\r
                </div>\r
              </div>\r
            </h5>\r
          </div>\r
...
\r
      <!-- Roles and Branches Card -->\r
      <div class="col-lg-4">\r
        <div class="card">\r
          <div class="card-header">\r
            <h6 class="card-title mb-0">{{ t('users.roles_and_access') }}</h6>\r
          </div>\r
          <div class="card-body">\r
            <!-- Roles -->\r
            <div class="mb-3">\r
              <h6 class="fw-semibold">{{ t('users.roles') }}</h6>\r
              <app-badge-list\r
                [items]="roleBadges()"\r
                [gap]="'sm'"\r
                [emptyMessage]="t('users.no_roles')">\r
              </app-badge-list>\r
            </div>\r
\r
            <!-- Branches -->\r
            <div>\r
              <h6 class="fw-semibold">{{ t('users.branches') }}</h6>\r
              <app-badge-list\r
                [items]="branchBadges()"\r
                [gap]="'sm'"\r
                [emptyMessage]="t('users.all_branches')">\r
              </app-badge-list>\r
            </div>\r
          </div>\r
        </div>\r
\r
            ...
            <div class="d-grid gap-2">\r
              <button \r
                *appHasPermission="PERMISSIONS.USER_ASSIGN_ROLE"\r
                ...
                (click)="onManageRoles()">\r
                <i class="fa-solid fa-user-tag me-2"></i>\r
                {{ t('users.manage_roles') }}\r
              </button>\r
              @if (user()?.isActive) {\r
                <button \r
                  *appHasPermission="PERMISSIONS.USER_LOCK"\r
                  type="button" \r
                  class="btn btn-outline-warning">\r
                  <i class="fa-solid fa-lock me-2"></i>\r
                  {{ t('users.lock_account') }}\r
                </button>\r
              } @else {\r
                <button \r
                  *appHasPermission="PERMISSIONS.USER_UNLOCK"\r
                  type="button" \r
                  class="btn btn-outline-success">\r
                  <i class="fa-solid fa-unlock me-2"></i>\r
                  {{ t('users.unlock_account') }}\r
                </button>\r
              }\r
            </div>\r
          </div>\r
    ...
    <div class="alert alert-danger">\r
      ...
      {{ error() || t('users.user_not_found') }}\r
    </div>\r
  }\r
...
//# sourceMappingURL=chunk-BYQBHG2E.js.map

...
(() => {
  ...
  <!-- Page Header -->
  <app-page-header [title]="t('dashboard.title')">
  </app-page-header>
  ...
  <div class="dashboard-controls mb-4">
    <div class="d-flex justify-content-between align-items-start">
      <div class="welcome-section">
        <p class="dashboard-subtitle mb-0">{{ t('dashboard.welcome', { username: currentUser()?.username || 'User' }) }}
        </p>
        @if (lastRefresh()) {
      ...
      <div class="controls-section">
        ...
        <div class="d-flex align-items-center gap-3">
          ...
          <div class="form-check form-switch">
            <input class="form-check-input" type="checkbox" id="autoRefreshToggle" [checked]="autoRefresh()"
          ...
          <div class="d-flex gap-2">
            ...
            <select class="form-select form-select-sm" [value]="filters().branchId || ''"
            ...
            <select class="form-select form-select-sm" [value]="filters().departmentId || ''"
  ...
  <div class="loading-overlay">
    <div class="loading-content">
      <app-loading-spinner [message]="t('dashboard.loading_comprehensive')" [variant]="'primary'" [centered]="true">
      </app-loading-spinner>
    </div>
  </div>
  }
  ...
  <div class="metrics-section">
    ...
    <app-stats-grid [stats]="dashboardStats()" [columns]="4" [loading]="loading()">
    </app-stats-grid>
  </div>
    ...
    <div class="widgets-grid">
      ...
      <div class="widget attendance-widget">
        <div class="widget-header d-flex justify-content-between align-items-center">
          ...
          <a routerLink="/reports/attendance" class="btn btn-sm btn-link text-decoration-none">
            {{ t('common.view_details') || 'View Details' }} <i class="fa-solid fa-arrow-right ms-1"></i>
          </a>
        </div>
        <div class="widget-content">
          <div class="attendance-stats">
            ...
            <div class="stat-item">
              ...
              <span class="stat-value text-primary">{{ (dashboardData()?.attendance.attendanceRate || 0) |
                number:'1.1-1' }}%</span>
            </div>
          </div>
          ...
          <div class="incomplete-records mt-3">
            ...
            <div class="records-list">
              @for (record of dashboardData()?.attendance?.incompleteRecords?.slice(0, 5) || []; track
              record.employeeId) {
      ...
      <div class="widget hr-widget">
        <div class="widget-header d-flex justify-content-between align-items-center">
          ...
          <a routerLink="/employees" class="btn btn-sm btn-link text-decoration-none">
            {{ t('common.view_details') || 'View Details' }} <i class="fa-solid fa-arrow-right ms-1"></i>
          </a>
        </div>
        <div class="widget-content">
      ...
      <div class="widget vacation-widget">
        <div class="widget-header d-flex justify-content-between align-items-center">
          ...
          <a routerLink="/approvals" class="btn btn-sm btn-link text-decoration-none">
            {{ t('common.view_details') || 'View Details' }} <i class="fa-solid fa-arrow-right ms-1"></i>
          </a>
        </div>
        <div class="widget-content">
          ...
          <div class="upcoming-vacations mt-3">
            ...
            <div class="vacation-item">
              ...
              <span class="vacation-dates">{{ vacation.startDate | date:'shortDate' }} - {{ vacation.endDate |
                date:'shortDate' }}</span>
            </div>
            }
          </div>
      ...
      <div class="widget shift-widget">
        <div class="widget-header d-flex justify-content-between align-items-center">
          ...
          <a routerLink="/shifts" class="btn btn-sm btn-link text-decoration-none">
            {{ t('common.view_details') || 'View Details' }} <i class="fa-solid fa-arrow-right ms-1"></i>
          </a>
        </div>
        <div class="widget-content">
  ...
  <div class="auto-refresh-settings">
    <div class="settings-card">
      ...
      <select id="refreshInterval" class="form-select form-select-sm" [value]="dashboardService.refreshInterval()"
...
//# sourceMappingURL=chunk-GGFETQI7.js.map

...
(() => {
  ...
  `, styles: ['/* angular:styles/component:css;e8171b9692b96c7b745382622623e329ba5a7786594dd1848a83906d2e2959f7;D:/Work/AI Code/TimeAttendanceSystem/time-attendance-frontend/src/app/pages/vacation-types/vacation-type-modal/vacation-type-modal.component.ts */\n.required::after {\n  content: " *";\n  color: red;\n}\n/*# sourceMappingURL=vacation-type-modal.component.css.map */\n'] }]
  }], null, { vacationType: [{
    type: Input
  }], isEdit: [{
    type: Input
...
function VacationTypesComponent_ng_template_6_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const item_r4 = \u0275\u0275nextContext().$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275textInterpolate1(" ", item_r4.branchName || ctx_r2.i18n.t("common.not_specified"), " ");
  }
}
...
function VacationTypesComponent_ng_template_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, VacationTypesComponent_ng_template_6_Conditional_0_Template, 4, 2, "div")(1, VacationTypesComponent_ng_template_6_Conditional_1_Template, 1, 1)(2, VacationTypesComponent_ng_template_6_Conditional_2_Template, 1, 2, "app-status-badge", 9)(3, VacationTypesComponent_ng_template_6_Conditional_3_Template, 2, 4)(4, VacationTypesComponent_ng_template_6_Conditional_4_Template, 1, 1);
  }
  if (rf & 2) {
...
__publicField(_VacationTypesComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VacationTypesComponent, selectors: [["app-vacation-types"]], viewQuery: /* @__PURE__ */ __name(function VacationTypesComponent_Query(rf, ctx) {
...
}, "VacationTypesComponent_Query"), decls: 9, vars: 17, consts: [["cellTemplate", ""], [1, "app-list-page"], [3, "title"], ["moduleName", "vacation-types", 3, "searchChange", "filtersChange", "add", "refresh", "refreshing"], [3, "message", "showRetry", "retryText"], [3, "title", "showHeader", "bodyClass"], [3, "actionClick", "pageChange", "pageSizeChange", "data", "columns", "actions", "loading", "currentPage", "totalPages", "totalItems", "pageSize", "showPagination", "emptyMessage", "emptyTitle"], [3, "modalClose", "vacationTypeCreated", "vacationTypeUpdated"], [3, "retry", "message", "showRetry", "retryText"], [3, "status", "label"], [1, "fw-medium"], [1, "text-muted", "small"]], template: /* @__PURE__ */ __name(function VacationTypesComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 1);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx.vacationTypes())("columns", ctx.tableColumns)("actions", ctx.tableActions)("loading", ctx.loading)("currentPage", ctx.currentPage)("totalPages", ctx.totalPages)("totalItems", ctx.totalItems)("pageSize", ctx.pageSize)("showPagination", true)("emptyMessage", ctx.i18n.t("vacation_types.no_vacation_types"))("emptyTitle", ctx.i18n.t("vacation_types.no_vacation_types_message"));
  }
...
\r
  <!-- Vacation Types Table using SectionCardComponent -->\r
  <app-section-card\r
    [title]="i18n.t('vacation_types.title')"\r
    [showHeader]="false"\r
    [bodyClass]="'p-0'">\r
    <app-data-table\r
      ...
      [emptyMessage]="i18n.t('vacation_types.no_vacation_types')"\r
      [emptyTitle]="i18n.t('vacation_types.no_vacation_types_message')"\r
    ...
    >\r
      ...
      <ng-template #cellTemplate let-item let-column="column">\r
        @if (column.key === 'name') {\r
          ...
          {{ item.branchName || i18n.t('common.not_specified') }}\r
...
//# sourceMappingURL=chunk-3KVCCVCY.js.map

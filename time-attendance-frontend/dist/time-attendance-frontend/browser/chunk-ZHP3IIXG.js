...
function ShiftsComponent_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "label", 9);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 30)(4, "input", 31);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_39_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.shiftForm.requiredHours, $event) || (ctx_r1.shiftForm.requiredHours = $event);
      return \u0275\u0275resetView($event);
    }, "ShiftsComponent_Conditional_39_Template_input_ngModelChange_4_listener"));
    \u0275\u0275elementEnd();
...
__name(ShiftsComponent_Conditional_39_Template, "ShiftsComponent_Conditional_39_Template");
function ShiftsComponent_Conditional_40_For_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 36)(1, "div", 42)(2, "div", 33)(3, "h6", 43);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 44);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_For_9_Template_button_click_5_listener() {
      const \u0275$index_99_r5 = \u0275\u0275restoreView(_r4).$index;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.removeShiftPeriod(\u0275$index_99_r5));
    }, "ShiftsComponent_Conditional_40_For_9_Template_button_click_5_listener"));
    \u0275\u0275element(6, "i", 45);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 14)(8, "div", 15)(9, "label", 11);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "input", 46);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_For_9_Template_input_ngModelChange_11_listener($event) {
      const period_r6 = \u0275\u0275restoreView(_r4).$implicit;
      \u0275\u0275twoWayBindingSet(period_r6.startTime, $event) || (period_r6.startTime = $event);
      return \u0275\u0275resetView($event);
    }, "ShiftsComponent_Conditional_40_For_9_Template_input_ngModelChange_11_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 15)(13, "label", 11);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "input", 46);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_For_9_Template_input_ngModelChange_15_listener($event) {
      const period_r6 = \u0275\u0275restoreView(_r4).$implicit;
      \u0275\u0275twoWayBindingSet(period_r6.endTime, $event) || (period_r6.endTime = $event);
      return \u0275\u0275resetView($event);
    }, "ShiftsComponent_Conditional_40_For_9_Template_input_ngModelChange_15_listener"));
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("name", "startTime" + \u0275$index_99_r5);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.t("shifts.fields.endTime"));
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", period_r6.endTime);
    \u0275\u0275property("name", "endTime" + \u0275$index_99_r5);
  }
}
__name(ShiftsComponent_Conditional_40_For_9_Template, "ShiftsComponent_Conditional_40_For_9_Template");
function ShiftsComponent_Conditional_40_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 15)(2, "label", 11);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 30)(5, "input", 47);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_Conditional_17_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.shiftForm.flexMinutesBefore, $event) || (ctx_r1.shiftForm.flexMinutesBefore = $event);
      return \u0275\u0275resetView($event);
    }, "ShiftsComponent_Conditional_40_Conditional_17_Template_input_ngModelChange_5_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "span", 32);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "div", 15)(9, "label", 11);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 30)(12, "input", 48);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_Conditional_17_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r1.shiftForm.flexMinutesAfter, $event) || (ctx_r1.shiftForm.flexMinutesAfter = $event);
      return \u0275\u0275resetView($event);
    }, "ShiftsComponent_Conditional_40_Conditional_17_Template_input_ngModelChange_12_listener"));
    \u0275\u0275elementEnd();
...
__name(ShiftsComponent_Conditional_40_Conditional_17_Template, "ShiftsComponent_Conditional_40_Conditional_17_Template");
function ShiftsComponent_Conditional_40_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
...
__name(ShiftsComponent_Conditional_40_Conditional_27_Template, "ShiftsComponent_Conditional_40_Conditional_27_Template");
function ShiftsComponent_Conditional_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div")(1, "div", 8)(2, "div", 33)(3, "label", 9);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 34);
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.addShiftPeriod());
    }, "ShiftsComponent_Conditional_40_Template_button_click_5_listener"));
    \u0275\u0275element(6, "i", 35);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(8, ShiftsComponent_Conditional_40_For_9_Template, 16, 9, "div", 36, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 8)(11, "div", 37)(12, "input", 38);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.shiftForm.allowFlexibleHours, $event) || (ctx_r1.shiftForm.allowFlexibleHours = $event);
      return \u0275\u0275resetView($event);
    }, "ShiftsComponent_Conditional_40_Template_input_ngModelChange_12_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_Template_input_change_12_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFlexibleHoursChange());
    }, "ShiftsComponent_Conditional_40_Template_input_change_12_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "label", 18);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "small", 19);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(17, ShiftsComponent_Conditional_40_Conditional_17_Template, 15, 6, "div", 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 8)(19, "label", 11);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 30)(22, "input", 39);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Conditional_40_Template_input_ngModelChange_22_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.shiftForm.gracePeriodMinutes, $event) || (ctx_r1.shiftForm.gracePeriodMinutes = $event);
      return \u0275\u0275resetView($event);
    }, "ShiftsComponent_Conditional_40_Template_input_ngModelChange_22_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "span", 32);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "small", 40);
    \u0275\u0275text(26);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(27, ShiftsComponent_Conditional_40_Conditional_27_Template, 3, 1, "small", 41);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
__name(ShiftsComponent_Conditional_40_Template, "ShiftsComponent_Conditional_40_Template");
function ShiftsComponent_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 26);
  }
}
__name(ShiftsComponent_Conditional_60_Template, "ShiftsComponent_Conditional_60_Template");
function ShiftsComponent_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
...
__name(ShiftsComponent_Conditional_66_Template, "ShiftsComponent_Conditional_66_Template");
function ShiftsComponent_Conditional_71_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 26);
  }
}
__name(ShiftsComponent_Conditional_71_Template, "ShiftsComponent_Conditional_71_Template");
function ShiftsComponent_Conditional_89_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 26);
  }
}
__name(ShiftsComponent_Conditional_89_Template, "ShiftsComponent_Conditional_89_Template");
...
__publicField(_ShiftsComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShiftsComponent, selectors: [["app-shifts"]], decls: 91, vars: 73, consts: [[1, "app-list-page"], [3, "title"], ["moduleName", "shifts", 3, "searchChange", "filtersChange", "add", "refresh", "refreshing"], [1, "card"], [1, "card-body"], [3, "actionClick", "pageChange", "pageSizeChange", "data", "columns", "actions", "loading", "currentPage", "totalPages", "totalItems", "pageSize", "emptyMessage", "emptyTitle", "responsiveMode"], [3, "close", "show", "title", "size", "centered", "loading"], [1, "modal-body"], [1, "mb-3"], [1, "form-label", "required"], ["type", "text", "name", "name", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-label"], ["rows", "2", "name", "description", 1, "form-control", 3, "ngModelChange", "ngModel"], ["name", "status", 3, "ngModelChange", "options", "ngModel", "placeholder", "required", "searchable", "clearable"], [1, "row"], [1, "col-md-6"], [1, "form-check"], ["type", "radio", "name", "shiftType", 1, "form-check-input", 3, "ngModelChange", "change", "value", "ngModel"], [1, "form-check-label"], [1, "form-text", "text-muted", "d-block"], [1, "row", "mb-3"], ["type", "checkbox", "name", "isCheckInRequired", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["type", "checkbox", "name", "isAutoCheckOut", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["modal-footer", "", 1, "d-flex", "gap-2", "justify-content-end"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"], [1, "spinner-border", "spinner-border-sm", "me-2"], [3, "close", "show", "title", "centered", "loading"], ["type", "button", 1, "btn", "btn-danger", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn-success", 3, "click", "disabled"], [1, "input-group"], ["type", "number", "name", "requiredHours", "min", "0.5", "max", "24", "step", "0.5", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "input-group-text"], [1, "d-flex", "justify-content-between", "align-items-center", "mb-2"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-primary", 3, "click", "disabled"], [1, "fas", "fa-plus", "me-1"], [1, "card", "mb-2"], [1, "form-check", "mb-2"], ["type", "checkbox", "name", "allowFlexibleHours", 1, "form-check-input", 3, "ngModelChange", "change", "ngModel"], ["type", "number", "name", "gracePeriodMinutes", "min", "1", "max", "120", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-text", "text-muted"], [1, "form-text", "text-info", "d-block"], [1, "card-body", "p-3"], [1, "mb-0"], ["type", "button", 1, "btn", "btn-sm", "btn-outline-danger", 3, "click", "disabled"], [1, "fas", "fa-trash"], ["type", "time", "required", "", 1, "form-control", 3, "ngModelChange", "ngModel", "name"], ["type", "number", "name", "flexMinutesBefore", "min", "1", "max", "480", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "number", "name", "flexMinutesAfter", "min", "1", "max", "480", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "fas", "fa-info-circle", "me-1"]], template: /* @__PURE__ */ __name(function ShiftsComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("actionClick", /* @__PURE__ */ __name(function ShiftsComponent_Template_app_data_table_actionClick_5_listener($event) {
      return ctx.onActionClick($event);
    }, "ShiftsComponent_Template_app_data_table_actionClick_5_listener"))("pageChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_app_data_table_pageChange_5_listener($event) {
      return ctx.onTablePageChange($event);
    }, "ShiftsComponent_Template_app_data_table_pageChange_5_listener"))("pageSizeChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_app_data_table_pageSizeChange_5_listener($event) {
      return ctx.onTablePageSizeChange($event);
    }, "ShiftsComponent_Template_app_data_table_pageSizeChange_5_listener"));
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(6, "app-modal-wrapper", 6);
    \u0275\u0275listener("close", /* @__PURE__ */ __name(function ShiftsComponent_Template_app_modal_wrapper_close_6_listener() {
      return ctx.onCloseModal();
    }, "ShiftsComponent_Template_app_modal_wrapper_close_6_listener"));
    \u0275\u0275elementStart(7, "div", 7)(8, "form")(9, "div", 8)(10, "label", 9);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "input", 10);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.name, $event) || (ctx.shiftForm.name = $event);
      return $event;
    }, "ShiftsComponent_Template_input_ngModelChange_12_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 8)(14, "label", 11);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "textarea", 12);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_textarea_ngModelChange_16_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.description, $event) || (ctx.shiftForm.description = $event);
      return $event;
    }, "ShiftsComponent_Template_textarea_ngModelChange_16_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 8)(18, "label", 9);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "app-searchable-select", 13);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_app_searchable_select_ngModelChange_20_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.status, $event) || (ctx.shiftForm.status = $event);
      return $event;
    }, "ShiftsComponent_Template_app_searchable_select_ngModelChange_20_listener"));
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "div", 8)(22, "label", 9);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 14)(25, "div", 15)(26, "div", 16)(27, "input", 17);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_input_ngModelChange_27_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.shiftType, $event) || (ctx.shiftForm.shiftType = $event);
      return $event;
    }, "ShiftsComponent_Template_input_ngModelChange_27_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function ShiftsComponent_Template_input_change_27_listener() {
      return ctx.onShiftTypeChange();
    }, "ShiftsComponent_Template_input_change_27_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "label", 18);
    \u0275\u0275text(29);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "small", 19);
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div", 15)(33, "div", 16)(34, "input", 17);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_input_ngModelChange_34_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.shiftType, $event) || (ctx.shiftForm.shiftType = $event);
      return $event;
    }, "ShiftsComponent_Template_input_ngModelChange_34_listener"));
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function ShiftsComponent_Template_input_change_34_listener() {
      return ctx.onShiftTypeChange();
    }, "ShiftsComponent_Template_input_change_34_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "label", 18);
    \u0275\u0275text(36);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "small", 19);
    \u0275\u0275text(38);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275conditionalCreate(39, ShiftsComponent_Conditional_39_Template, 7, 3, "div", 8);
    \u0275\u0275conditionalCreate(40, ShiftsComponent_Conditional_40_Template, 28, 12, "div");
    \u0275\u0275elementStart(41, "div", 20)(42, "div", 15)(43, "div", 16)(44, "input", 21);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_input_ngModelChange_44_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isCheckInRequired, $event) || (ctx.shiftForm.isCheckInRequired = $event);
      return $event;
    }, "ShiftsComponent_Template_input_ngModelChange_44_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "label", 18);
    \u0275\u0275text(46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "small", 19);
    \u0275\u0275text(48);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(49, "div", 15)(50, "div", 16)(51, "input", 22);
    \u0275\u0275twoWayListener("ngModelChange", /* @__PURE__ */ __name(function ShiftsComponent_Template_input_ngModelChange_51_listener($event) {
      \u0275\u0275twoWayBindingSet(ctx.shiftForm.isAutoCheckOut, $event) || (ctx.shiftForm.isAutoCheckOut = $event);
      return $event;
    }, "ShiftsComponent_Template_input_ngModelChange_51_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "label", 18);
    \u0275\u0275text(53);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "small", 19);
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275elementStart(56, "div", 23)(57, "button", 24);
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ShiftsComponent_Template_button_click_59_listener() {
      return ctx.showCreateModal() ? ctx.onSubmitCreate() : ctx.onSubmitEdit();
    }, "ShiftsComponent_Template_button_click_59_listener"));
    \u0275\u0275conditionalCreate(60, ShiftsComponent_Conditional_60_Template, 1, 0, "span", 26);
    \u0275\u0275text(61);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(62, "app-modal-wrapper", 27);
    \u0275\u0275listener("close", /* @__PURE__ */ __name(function ShiftsComponent_Template_app_modal_wrapper_close_62_listener() {
      return ctx.onCloseModal();
    }, "ShiftsComponent_Template_app_modal_wrapper_close_62_listener"));
    \u0275\u0275elementStart(63, "div", 7)(64, "p");
    \u0275\u0275text(65);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(66, ShiftsComponent_Conditional_66_Template, 3, 1, "p");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ShiftsComponent_Template_button_click_70_listener() {
      return ctx.onConfirmDelete();
    }, "ShiftsComponent_Template_button_click_70_listener"));
    \u0275\u0275conditionalCreate(71, ShiftsComponent_Conditional_71_Template, 1, 0, "span", 26);
    \u0275\u0275text(72);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(73, "app-modal-wrapper", 27);
    \u0275\u0275listener("close", /* @__PURE__ */ __name(function ShiftsComponent_Template_app_modal_wrapper_close_73_listener() {
      return ctx.onCloseModal();
    }, "ShiftsComponent_Template_app_modal_wrapper_close_73_listener"));
    \u0275\u0275elementStart(74, "div", 7)(75, "p");
    \u0275\u0275text(76);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "p")(78, "strong");
    \u0275\u0275text(79);
    \u0275\u0275elementEnd();
    \u0275\u0275text(80);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(84);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(85, "div", 23)(86, "button", 24);
    ...
    \u0275\u0275listener("click", /* @__PURE__ */ __name(function ShiftsComponent_Template_button_click_88_listener() {
      return ctx.onConfirmSetDefaultShift();
    }, "ShiftsComponent_Template_button_click_88_listener"));
    \u0275\u0275conditionalCreate(89, ShiftsComponent_Conditional_89_Template, 1, 0, "span", 26);
    \u0275\u0275text(90);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("data", ctx.tableData())("columns", ctx.tableColumns())("actions", ctx.tableActions())("loading", ctx.loading)("currentPage", ctx.currentPage)("totalPages", ctx.totalPages)("totalItems", ctx.totalCount)("pageSize", ctx.pageSize)("emptyMessage", ctx.t("shifts.noShifts"))("emptyTitle", ctx.t("shifts.noShiftsDescription"))("responsiveMode", "auto");
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.shiftForm.shiftType === ctx.ShiftType.HoursOnly ? 39 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.shiftForm.shiftType === ctx.ShiftType.TimeBased ? 40 : -1);
    \u0275\u0275advance(4);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.submitting() ? 60 : -1);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.selectedShift() ? 66 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx.t("common.cancel"), " ");
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx.submitting());
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx.submitting() ? 71 : -1);
    \u0275\u0275advance();
...
//# sourceMappingURL=chunk-ZHP3IIXG.js.map

...
\r
  ...
  @if (!loading() && policy()) {\r
    ...
    <app-form-header\r
      mode="view"\r
      [title]="t('excuse_policies.policy_details')"\r
        ...
        <div class="card">\r
          <div class="card-header bg-light">\r
            <h6 class="mb-0">\r
              ...
              {{ t('excuse_policies.basic_information') }}\r
            </h6>\r
          </div>\r
          <div class="card-body">\r
            <app-definition-list [items]="basicInfoItems()">\r
              <!-- Custom status badge content -->\r
              <ng-container *ngTemplateOutlet="statusBadgeTemplate"></ng-container>\r
...
\r
      ...
      <div class="col-md-6 mb-4">\r
        <div class="card">\r
          ...
          <div class="card-body">\r
            <app-definition-list [items]="monthlyLimitsItems()"></app-definition-list>\r
          </div>\r
        </div>\r
      </div>\r
\r
      ...
      <div class="col-md-6 mb-4">\r
        <div class="card">\r
          ...
          <div class="card-body">\r
            <app-definition-list [items]="timeLimitsItems()"></app-definition-list>\r
          </div>\r
        </div>\r
      </div>\r
\r
      ...
      <div class="col-md-6 mb-4">\r
        <div class="card">\r
          ...
          <div class="card-body">\r
            <app-definition-list [items]="policyOptionsItems()"></app-definition-list>\r
          </div>\r
        </div>\r
      </div>\r
\r
      ...
      <div class="col-12 mb-4">\r
        <div class="card">\r
          <div class="card-header bg-light">\r
            <h6 class="mb-0">\r
              <i class="fas fa-history me-2"></i>\r
              {{ t('excuse_policies.audit_information') }}\r
            </h6>\r
          </div>\r
          <div class="card-body">\r
            <app-definition-list [items]="auditInfoItems()" [labelWidth]="'2'" [valueWidth]="'10'"></app-definition-list>\r
          </div>\r
        </div>\r
      </div>\r
    </div>\r
...
\r
<!-- Status Badge Template -->\r
<ng-template #statusBadgeTemplate>\r
  <app-status-badge\r
...
//# sourceMappingURL=chunk-SCR6ICAR.js.map

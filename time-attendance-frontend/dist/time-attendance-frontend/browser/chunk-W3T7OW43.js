...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmployeeTableComponent, [{
    ...
    `, styles: ["/* angular:styles/component:css;b01443c16e75437b73dd8a728713eee6579ca4d4c02199e6657f116651c97be5;D:/Work/TimeAttendanceSystem/time-attendance-frontend/src/app/pages/employees/employee-table/employee-table.component.ts */\n.avatar-sm {\n  width: 2rem;\n  height: 2rem;\n}\n.avatar-initial {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100%;\n  height: 100%;\n  font-size: 0.875rem;\n  font-weight: 600;\n}\n/*# sourceMappingURL=employee-table.component.css.map */\n"] }]
  }], null, { employees: [{
    type: Input
  }], loading: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(EmployeesComponent, [{
    type: Component,
    args: [{ selector: "app-employees", standalone: true, imports: [UnifiedFilterComponent, EmployeeTableComponent, PageHeaderComponent], template: `<div class="employees-page">\r
  <!-- Page Header -->\r
  <app-page-header\r
    [title]="i18n.t('employees.title')">\r
  </app-page-header>\r
\r
  <!-- Filters Component -->\r
  <app-unified-filter\r
    [searchPlaceholder]="i18n.t('employees.search_placeholder')"\r
    [showAddButton]="true"\r
    [addButtonText]="i18n.t('employees.add_employee')"\r
    [showRefreshButton]="true"\r
    [refreshButtonText]="i18n.t('common.refresh')"\r
...
\r
  <!-- Employees Table Component -->\r
  <app-employee-table\r
    [employees]="employees()"\r
    [loading]="loading"\r
    [currentPage]="currentPage"\r
    [totalPages]="totalPages"\r
    [totalItems]="totalCount"\r
    [pageSize]="pageSize"\r
    (viewEmployee)="onViewEmployee($event)"\r
    (editEmployee)="onEditEmployee($event)"\r
    (deleteEmployee)="onDeleteEmployee($event)"\r
    (changeShift)="onChangeShift($event)"\r
...
//# sourceMappingURL=chunk-W3T7OW43.js.map

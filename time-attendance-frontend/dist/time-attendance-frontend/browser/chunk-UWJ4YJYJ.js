...
function EditRoleComponent_Conditional_19_For_46_For_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 61)(1, "div", 62)(2, "div", 63)(3, "input", 64);
    \u0275\u0275listener("change", /* @__PURE__ */ __name(function EditRoleComponent_Conditional_19_For_46_For_8_Template_input_change_3_listener() {
      const permission_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r0.onTogglePermission(permission_r4));
    }, "EditRoleComponent_Conditional_19_For_46_For_8_Template_input_change_3_listener"));
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 65)(5, "div", 66);
    \u0275\u0275element(6, "i", 67);
    \u0275\u0275elementStart(7, "label", 68)(8, "small");
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275classProp("bg-light", ctx_r0.isPermissionSelected(permission_r4.id));
    \u0275\u0275advance(2);
    \u0275\u0275property("id", "permission-" + permission_r4.id)("checked", ctx_r0.isPermissionSelected(permission_r4.id))("disabled", ctx_r0.saving());
    \u0275\u0275advance(3);
...
__name(EditRoleComponent_Conditional_19_For_46_For_8_Template, "EditRoleComponent_Conditional_19_For_46_For_8_Template");
function EditRoleComponent_Conditional_19_For_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "h6", 57);
    \u0275\u0275element(2, "i", 58);
    \u0275\u0275text(3);
    \u0275\u0275elementStart(4, "small", 59);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 60);
    \u0275\u0275repeaterCreate(7, EditRoleComponent_Conditional_19_For_46_For_8_Template, 14, 11, "div", 61, _forTrack1);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function EditRoleComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(45, EditRoleComponent_Conditional_19_For_46_Template, 9, 2, "div", 47, _forTrack0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EditRoleComponent, { className: "EditRoleComponent", filePath: "src/app/pages/roles/edit-role/edit-role.component.ts", lineNumber: 250 });
})();
export {
  EditRoleComponent
};
//# sourceMappingURL=chunk-UWJ4YJYJ.js.map

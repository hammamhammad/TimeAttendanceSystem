...
__publicField(_PublicHolidaysComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PublicHolidaysComponent, selectors: [["app-public-holidays"]], decls: 46, vars: 33, consts: [[1, "container-fluid"], [3, "title"], ["moduleName", "public-holidays", 3, "searchChange", "filtersChange", "add", "refresh", "refreshing"], [1, "d-flex", "justify-content-end", "align-items-center", "mb-4"], [1, "d-flex", "gap-2"], [1, "dropdown"], ["type", "button", 1, "btn", "btn-outline-primary"], [1, "card"], [1, "card-body"], [3, "actionClick", "pageChange", "pageSizeChange", "data", "columns", "actions", "loading", "totalItems", "currentPage", "pageSize", "totalPages"], [3, "close", "show", "title", "centered", "loading"], [1, "modal-body"], [1, "mb-3"], ["for", "template", 1, "form-label"], ["id", "template", 1, "form-select", 3, "ngModelChange", "ngModel"], [3, "value"], ["for", "importYear", 1, "form-label"], ["id", "importYear", 1, "form-select", 3, "ngModelChange", "ngModel"], ["for", "importBranch", 1, "form-label"], ["id", "importBranch", 1, "form-select", 3, "ngModelChange", "ngModel"], [1, "form-text"], [1, "form-check"], ["type", "checkbox", "id", "overwriteExisting", 1, "form-check-input", 3, "ngModelChange", "ngModel"], ["for", "overwriteExisting", 1, "form-check-label"], ["modal-footer", "", 1, "d-flex", "gap-2", "justify-content-end"], ["type", "button", 1, "btn", "btn-secondary", 3, "click", "disabled"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"], ["role", "status", "aria-hidden", "true", 1, "spinner-border", "spinner-border-sm", "me-1"], ["type", "button", "data-bs-toggle", "dropdown", "aria-expanded", "false", 1, "btn", "btn-outline-secondary", "dropdown-toggle"], [1, "fas", "fa-download", "me-1"], [1, "dropdown-menu"], ["href", "#", 1, "dropdown-item", 3, "click"], [1, "fas", "fa-file-code", "me-2"], [1, "fas", "fa-file-csv", "me-2"], [1, "fas", "fa-calendar", "me-2"], ["type", "button", 1, "btn", "btn-outline-primary", 3, "click"], [1, "fas", "fa-upload", "me-1"]], template: /* @__PURE__ */ __name(function PublicHolidaysComponent_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("data", ctx.tableData())("columns", ctx.tableColumns())("actions", ctx.tableActions())("loading", ctx.loading)("totalItems", ctx.totalCount)("currentPage", ctx.currentPage)("pageSize", ctx.pageSize)("totalPages", ctx.totalPages);
    \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PublicHolidaysComponent, [{
    type: Component,
    args: [{ selector: "app-public-holidays", standalone: true, imports: [CommonModule, FormsModule, DataTableComponent, PageHeaderComponent, UnifiedFilterComponent, ModalWrapperComponent], template: `<div class="container-fluid">\r
  <!-- Page Header -->\r
  <app-page-header\r
...
//# sourceMappingURL=chunk-ZTK2WL5Q.js.map

...
function patchJasmine(Zone2) {
  Zone2.__load_patch("jasmine", (global2, Zone3, api) => {
    const __extends = /* @__PURE__ */ __name(function(d, b) {
      for (const p in b)
    ...
    __name(wrapDescribeInZone, "wrapDescribeInZone");
    ...
    __name(runInTestZone, "runInTestZone");
    ...
    __name(wrapTestInZone, "wrapTestInZone");
    ...
    jasmine.QueueRunner = (function(_super) {
      ...
      __name(ZoneQueueRunner, "ZoneQueueRunner");
...
__name(patchJasmine, "patchJasmine");
function patchJest(Zone2) {
  Zone2.__load_patch("jest", (context, Zone3, api) => {
    ...
    __name(wrapDescribeFactoryInZone, "wrapDescribeFactoryInZone");
    ...
    __name(wrapTestFactoryInZone, "wrapTestFactoryInZone");
    ...
    function wrapTestInZone(testBody, isTestFunc = false) {
      ...
      const wrappedFunc = /* @__PURE__ */ __name(function() {
    ...
    Zone3.patchJestObject = /* @__PURE__ */ __name(function patchJestObject(Timer, isModern = false) {
      function isPatchingFakeTimer() {
        const fakeAsyncZoneSpec = Zone3.current.get("FakeAsyncTestZoneSpec");
        return !!fakeAsyncZoneSpec;
      }
      __name(isPatchingFakeTimer, "isPatchingFakeTimer");
      function isInTestFunc() {
        const proxyZoneSpec2 = Zone3.current.get("ProxyZoneSpec");
        return proxyZoneSpec2 && proxyZoneSpec2.isTestFunc;
      }
      __name(isInTestFunc, "isInTestFunc");
...
function patchMocha(Zone2) {
  Zone2.__load_patch("mocha", (global2, Zone3) => {
    ...
    __name(modifyArguments, "modifyArguments");
    function wrapDescribeInZone(args) {
      const syncTest = /* @__PURE__ */ __name(function(fn) {
        return function() {
    ...
    function wrapTestInZone(args) {
      const asyncTest = /* @__PURE__ */ __name(function(fn) {
    ...
    __name(wrapSuiteInZone, "wrapSuiteInZone");
...
var _AsyncTestZoneSpec = class _AsyncTestZoneSpec {
  finishCallback;
  failCallback;
...
__name(_AsyncTestZoneSpec, "AsyncTestZoneSpec");
var AsyncTestZoneSpec = _AsyncTestZoneSpec;
function patchAsyncTest(Zone2) {
  Zone2["AsyncTestZoneSpec"] = AsyncTestZoneSpec;
  Zone2.__load_patch("asynctest", (global2, Zone3, api) => {
    Zone3[api.symbol("asyncTest")] = /* @__PURE__ */ __name(function asyncTest(fn) {
      if (global2.jasmine) {
        return function(done) {
          if (!done) {
...
__name(patchAsyncTest, "patchAsyncTest");
...
var patchedTimers;
var timeoutCallback = /* @__PURE__ */ __name(function() {
}, "timeoutCallback");
...
var _FakeAsyncTestZoneSpec = class _FakeAsyncTestZoneSpec {
  ...
  flushMicrotasks() {
    _FakeAsyncTestZoneSpec.assertInZone();
    const flushErrors = /* @__PURE__ */ __name(() => {
...
__name(_FakeAsyncTestZoneSpec, "FakeAsyncTestZoneSpec");
var FakeAsyncTestZoneSpec = _FakeAsyncTestZoneSpec;
var _fakeAsyncTestZoneSpec = null;
function getProxyZoneSpec() {
  return Zone && Zone["ProxyZoneSpec"];
}
__name(getProxyZoneSpec, "getProxyZoneSpec");
...
__name(resetFakeAsyncZone, "resetFakeAsyncZone");
function fakeAsync(fn, options = {}) {
  const { flush: flush2 = true } = options;
  const fakeAsyncFn = /* @__PURE__ */ __name(function(...args) {
...
__name(_getFakeAsyncZoneSpec, "_getFakeAsyncZoneSpec");
...
__name(discardPeriodicTasks, "discardPeriodicTasks");
function withProxyZone(fn) {
  const autoProxyFn = /* @__PURE__ */ __name(function(...args) {
...
__name(withProxyZone, "withProxyZone");
...
__name(getOrCreateRootProxy, "getOrCreateRootProxy");
...
__name(patchFakeAsyncTest, "patchFakeAsyncTest");
function patchLongStackTrace(Zone2) {
  ...
  const _LongStackTrace = class _LongStackTrace {
    error = getStacktrace();
    timestamp = /* @__PURE__ */ new Date();
  };
  __name(_LongStackTrace, "LongStackTrace");
  let LongStackTrace = _LongStackTrace;
  function getStacktraceWithUncaughtError() {
    return new Error(ERROR_TAG);
  }
  __name(getStacktraceWithUncaughtError, "getStacktraceWithUncaughtError");
  ...
  __name(getStacktraceWithCaughtError, "getStacktraceWithCaughtError");
  ...
  __name(addErrorStack, "addErrorStack");
  ...
  __name(renderLongStackTrace, "renderLongStackTrace");
  function stackTracesEnabled() {
    return Error.stackTraceLimit > 0;
  }
  __name(stackTracesEnabled, "stackTracesEnabled");
  Zone2["longStackTraceZoneSpec"] = {
    ...
    getLongStackTrace: /* @__PURE__ */ __name(function(error2) {
      if (!error2) {
        return void 0;
      }
    ...
    onScheduleTask: /* @__PURE__ */ __name(function(parentZoneDelegate, currentZone, targetZone, task) {
    ...
    onHandleError: /* @__PURE__ */ __name(function(parentZoneDelegate, currentZone, targetZone, error2) {
      if (stackTracesEnabled()) {
  ...
  __name(captureStackTraces, "captureStackTraces");
  ...
  __name(computeIgnoreFrames, "computeIgnoreFrames");
  computeIgnoreFrames();
}
__name(patchLongStackTrace, "patchLongStackTrace");
var _ProxyZoneSpec = class _ProxyZoneSpec {
  defaultSpecDelegate;
  name = "ProxyZone";
  _delegateSpec = null;
...
__name(_ProxyZoneSpec, "ProxyZoneSpec");
var ProxyZoneSpec = _ProxyZoneSpec;
function patchProxyZoneSpec(Zone2) {
  Zone2["ProxyZoneSpec"] = ProxyZoneSpec;
}
__name(patchProxyZoneSpec, "patchProxyZoneSpec");
function patchSyncTest(Zone2) {
  const _SyncTestZoneSpec = class _SyncTestZoneSpec {
  ...
  __name(_SyncTestZoneSpec, "SyncTestZoneSpec");
  let SyncTestZoneSpec = _SyncTestZoneSpec;
  Zone2["SyncTestZoneSpec"] = SyncTestZoneSpec;
}
__name(patchSyncTest, "patchSyncTest");
function patchPromiseTesting(Zone2) {
  Zone2.__load_patch("promisefortest", (global2, Zone3, api) => {
    ...
    Promise[api.symbol("patchPromiseForTest")] = /* @__PURE__ */ __name(function patchPromiseForTest() {
    ...
    Promise[api.symbol("unPatchPromiseForTest")] = /* @__PURE__ */ __name(function unpatchPromiseForTest() {
...
__name(patchPromiseTesting, "patchPromiseTesting");
...
__name(rollupTesting, "rollupTesting");
rollupTesting(Zone);

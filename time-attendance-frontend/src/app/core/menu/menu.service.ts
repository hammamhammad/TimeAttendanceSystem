...
export class MenuService {
  private readonly menuGroups = signal<MenuGroup[]>([
    ...
    // ── ORGANIZATION ──
    {
      ...
      items: [
        ...
        { path: '/roles', titleKey: 'nav.roles', icon: 'fa-solid fa-user-shield', permission: 'role.read' },
        { path: '/branches', titleKey: 'nav.branches', icon: 'fa-solid fa-code-branch', permission: 'branch.read' },
        { path: '/departments', titleKey: 'nav.departments', icon: 'fa-solid fa-sitemap', permission: 'department.read' }
      ]
    },
    // ── TIME & ATTENDANCE ──
    {
      ...
      items: [
        {
          ...
          children: [
            ...
            { path: '/payroll/settings', titleKey: 'nav.payrollSettings', icon: 'fa-solid fa-cog', permission: 'payroll.manage' }
          ]
        },
        {
          path: '/benefits',
      ...
      items: [
        {
          ...
          permission: undefined,
          children: [
            { path: '/approvals', titleKey: 'approvals.pending_title', icon: 'fa-solid fa-clock', permission: 'approval.read' },
            { path: '/approvals/history', titleKey: 'approvals.history_title', icon: 'fa-solid fa-history', permission: 'approval.read' }
          ]
        }
      ]
    },
      ...
      items: [
        {
          ...
          permission: undefined,
          children: [
            { path: '/reports/attendance', titleKey: 'reports.attendance.title', icon: 'fa-solid fa-list-check', permission: 'attendance.read' },
  ...
  // Flattened menu items for backward compatibility

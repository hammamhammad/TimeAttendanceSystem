...
@Component({
  selector: 'app-excuse-policy-filters',
  standalone: true,
  ...
  template: `
    <app-search-filter
      ...
      [searchPlaceholder]="'Search excuse policies...'"
...
export class ExcusePolicyFiltersComponent implements OnInit {
  private i18n = inject(I18nService);

  @Input() showAddButton = true;
  @Input() addButtonText = 'Create Policy';

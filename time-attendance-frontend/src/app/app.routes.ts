    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'templates', loadComponent: () => import('./pages/settings/tenant-configuration/policy-templates/policy-templates.component').then(m => m.PolicyTemplatesComponent), data: { title: 'tenant_configuration.templates.title' } },
          { path: 'setup-status', loadComponent: () => import('./pages/settings/tenant-configuration/setup-status/setup-status.component').then(m => m.SetupStatusComponent), data: { title: 'tenant_configuration.setup_status.title' } },
        ]
      },
      {
      ...
      // Tenant Management Routes
      {
        ...
        data: { title: 'Tenants', permission: 'system.manage' },
        canMatch: [systemAdminGuard]
      },
      {
        path: 'tenants/create',
        loadComponent: () => import('./pages/tenants/create-tenant/create-tenant.component').then(m => m.CreateTenantComponent),
        data: { title: 'Create Tenant', permission: 'system.manage' },
        canMatch: [systemAdminGuard]
      },
      {
        path: 'tenants/:id',
        loadComponent: () => import('./pages/tenants/view-tenant/view-tenant.component').then(m => m.ViewTenantComponent),
        data: { title: 'View Tenant', permission: 'system.manage' },
        canMatch: [systemAdminGuard]
      },
      {
        path: 'tenants/:id/edit',
        loadComponent: () => import('./pages/tenants/edit-tenant/edit-tenant.component').then(m => m.EditTenantComponent),
        data: { title: 'Edit Tenant', permission: 'system.manage' },
        canMatch: [systemAdminGuard]
      },
      {
